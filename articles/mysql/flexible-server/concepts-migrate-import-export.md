...
1. In the Azure portal, look for the connection information on the **Overview** pane of your Azure Database for MySQL Flexible Server instance.
   ...
   :::image type="content" source="media/concepts-migrate-import-export/1-server-overview-name-login.png" alt-text="Screenshot of the Azure Database for MySQL Flexible Server instance connection information in the Azure portal." lightbox="media/concepts-migrate-import-export/1-server-overview-name-login.png":::

1. Add the connection information to MySQL Workbench.

   :::image type="content" source="media/concepts-migrate-import-export/2-setup-new-connection.png" alt-text="Screenshot of the MySQL Workbench connection string." lightbox="media/concepts-migrate-import-export/2-setup-new-connection.png":::
...
:::image type="content" source="media/concepts-migrate-import-export/p2.png" alt-text="Screenshot of using the Navigator pane to display the Data Export pane in MySQL Workbench." lightbox="media/concepts-migrate-import-export/p2.png":::
...
:::image type="content" source="media/concepts-migrate-import-export/p3.png" alt-text="Screenshot of using the Navigator pane to display the Data Import pane in MySQL Workbench." lightbox="media/concepts-migrate-import-export/p3.png":::
...
- [Migrate your MySQL database to Azure Database for MySQL - Flexible Server using dump and restore](concepts-migrate-dump-restore.md)
