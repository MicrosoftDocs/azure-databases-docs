...
To learn more about the application code, go ahead and explore the app in the [GitHub repository](https://github.com/Azure-Samples/php-mysql-app-service). To learn how to connect a PHP app to Azure Database for MySQL flexible server, refer [Use PHP with Azure Database for MySQL - Flexible Server](connect-php.md).
