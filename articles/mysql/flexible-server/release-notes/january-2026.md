...
> - For some Azure Database for MySQL instances in Azure National Clouds, the certificate issued by the current Certificate Authority (CA) is expected to expire before February 6th, 2026. Once the certificate expires, client connections to the server fail, resulting in service unavailability.
