...
- US and small non-US region servers will be upgraded to a FIPS-compliant version by default. [Learn more](https://learn.microsoft.com/azure/compliance/offerings/offering-fips-140-2)
