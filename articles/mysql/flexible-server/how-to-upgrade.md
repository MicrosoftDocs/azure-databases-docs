...
2. Perform Pre-Upgrade Validation
    ...
    > - Potential for Hanging Due to Large Result Sets: In some instances—particularly with complex databases containing many objects—the validation result might become too large to be processed or displayed within the online workflow. This might result in the 'Validate' operation appearing to hang, timeout or remain in progress indefinitely.
    >  
