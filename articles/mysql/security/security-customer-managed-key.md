...
After you enable logging, auditors can use Azure Monitor to review Key Vault audit event logs. To enable logging of [Key Vault auditing events](/azure/key-vault/key-vault-insights-overview), see Monitoring your key vault service with Key Vault insights.
...
- [Data encryption for Azure Database for MySQL flexible server with the Azure portal](security-how-to-data-encryption-portal.md)
