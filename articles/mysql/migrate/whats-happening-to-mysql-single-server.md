...
- If complex features such as CMK, Microsoft Entra ID, Read Replica, Virtual Network, Double Infrastructure Encryption, or Service Endpoint/VNet Rules are enabled in MySQL Single Server, the auto migration is likely to fail, as this scenario is unsupported for auto migration. Recommendation to disable these features before migration and re-enabling them afterward.
