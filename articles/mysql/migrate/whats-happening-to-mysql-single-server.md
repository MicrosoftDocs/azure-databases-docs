...
- Microsoft Entra authentication (erstwhile Microsoft Entra ID) - Iff the username for AAD user contains ‘@email’ , then use the old connection string format - user@email.com@server_name to connect to migrated Flexible Server instance. Read more about how to configure [here](../flexible-server/how-to-azure-ad.md)
