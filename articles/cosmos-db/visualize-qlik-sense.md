---
title: Connect Qlik Sense to and Visualize Your Data
...
* Download the [Qlik Sense Desktop](https://www.qlik.com/us/trial/download-qlik-sense-desktop) or set up Qlik Sense in Azure by [Installing the Qlik Sense marketplace item](https://marketplace.microsoft.com/).
...
* [Create a database and a collection](quickstart-java.md) – You can use set the collection throughput value to 1000 RU/s. 
