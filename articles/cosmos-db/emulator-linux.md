...
When using the [Java SDK for Azure Cosmos DB](https://learn.microsoft.com/java/api/overview/azure/cosmos-readme?view=azure-java-stable) with this version of the emulator in https mode, it is necessary to install it's certificates to your local Java trust store.
