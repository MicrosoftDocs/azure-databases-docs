...
Follow [best practices](partitioning-overview.md#choose-a-partition-key) for choosing a partition key to ensure you will have even distribution of request volume and storage post-migration. 
