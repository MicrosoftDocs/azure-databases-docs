...
Spatial indexes can be used on correctly formatted [GeoJSON](/nosql/query/geospatial) objects. Points, LineStrings, Polygons, and MultiPolygons are currently supported. To learn how to configure spatial indexes, see [Manage indexing policies in Azure Cosmos DB](how-to-manage-indexing-policy.md).
