...
1. On the **Select API option** page, select the **Create** option within the **Azure Table** section. Azure Cosmos DB has five APIs: SQL, MongoDB, Gremlin, Table, and Cassandra. [Learn more about the API for Table](../../introduction.md).

    :::image type="content" source="../../media/dotnet-quickstart/azure-portal-create-cosmos-db-account-table-api-3.png" alt-text="A screenshot showing how to select the API for Table for an Azure Cosmos DB account.":::    
...
1. On the **Create Azure Cosmos DB Account** page, enter the following information:
   ...
   > You can have up to one free tier Azure Cosmos DB account per Azure subscription and must opt-in when creating the account. If you do not see the option to apply the free tier discount, this means another account in the subscription has already been enabled with free tier.
    ...
    :::image type="content" source="../../media/dotnet-quickstart/azure-portal-create-cosmos-db-account-table-api.png" alt-text="A screenshot showing how to create an Azure Cosmos DB account using the API for Table.":::    
