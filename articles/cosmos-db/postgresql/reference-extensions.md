...
> | [old\_snapshot](https://www.postgresql.org/docs/16/oldsnapshot.html) | Allows inspection of the server state that is used to implement old_snapshot_threshold. |     |     |     | 1.0 | 1.0 | 1.0 |
