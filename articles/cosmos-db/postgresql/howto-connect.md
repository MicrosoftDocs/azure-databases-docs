...
1. Enter connection details in the Connection tab.
   ...
   * **Password**: the connection password or the Microsoft Entra ID token.
...
1. In the connection string you copied, replace `<your_password>` with your administrative password or the Microsoft Entra ID token.
