...
1. Delete the failed cluster entity.
    > [!NOTE] The failed cluster has `clusterStatus` property set to **Failed**. In the Azure portal, you can find cluster status on the **Overview** blade in the cluster properties.
