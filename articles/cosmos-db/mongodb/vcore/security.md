...
|--------------------|-----------------------------------|
|Network security|Private access implemented via [the mature Private Link technology](/azure/private-link/private-link-overview) allows to provide access to cluster for resources in Azure VNets. Public access allows to open cluster to a defined set of public IP addresses. Private and public access can be combined and enabled or disabled at any time.|
