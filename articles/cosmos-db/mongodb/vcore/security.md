...
|Secondary accounts|For more granular access [secondary user accounts](./secondary-users.md) can be created on clusters with read-write or read-only priviliges on the cluster's databases.|
