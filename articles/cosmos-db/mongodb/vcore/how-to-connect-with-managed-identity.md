---
title: Use managed identity and Microsoft Entra ID to authenticate to Azure Cosmos DB for MongoDB vCore
titleSuffix: Azure Cosmos DB for MongoDB vCore
description: Learn how to set up and use managed identity for authentication on Azure Cosmos DB for MongoDB vCore clusters.
author: niklarin
ms.author: nlarin
...
# Connect with managed identity to Azure Cosmos DB for MongoDB vCore
...
You can use system-assigned managed identity to authenticate to Azure Cosmos DB for MongoDB vCore. This article shows you how to use a system-assigned managed identity for an Azure virtual machine (VM) to access an Azure Cosmos DB for MongoDB vCore cluster. Managed identities are automatically managed by Azure and enable you to authenticate to services that support Microsoft Entra authentication without having credentials in your code.

You learn how to:

- Assign managed identity to a VM.
- Add VM's managed identity as an Entra ID security principal to an Azure Cosmos DB for MongoDB vCore cluster.
- Get an access token using the VM identity and use it to query an Azure Cosmos DB for MongoDB vCore database.
