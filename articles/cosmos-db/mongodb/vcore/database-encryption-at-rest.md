...
- Enable [key autorotation](/azure/key-vault/keys/how-to-configure-key-rotation). The latest version of the selected key will be always picked up by Azure Cosmos DB for MongoDB vCore service. 
