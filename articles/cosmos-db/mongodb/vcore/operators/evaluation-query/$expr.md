...
This query retrieves stores with more full-time employees than part-time employees.
...
This query demonstrates the conditional logic usage with $expr pulling stores in the southern hemisphere where the staff efficiency ratio (sales per employee) exceeds 2000.
