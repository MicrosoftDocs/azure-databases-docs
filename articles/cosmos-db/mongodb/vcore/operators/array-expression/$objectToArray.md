---
  title: $objectToArray (as Array Expression Operator) usage on Azure Cosmos DB for MongoDB vCore
  titleSuffix: Azure Cosmos DB for MongoDB vCore
  description: Learn the syntax and see examples of how to use $objectToArray (as Array Expression) operator.
  author: sandeep-nair
  ms.author: sandnair
