...
description: The $integral operator in Azure Cosmos DB for MongoDB vCore calculates the area under a curve with the specified range of documents forming the adjacent documents for the calculation.
author: abinav2307
ms.author: abramees
...
### Example 1 - Calculate the integral of the total sales across all stores under the Boulder Innovations company
