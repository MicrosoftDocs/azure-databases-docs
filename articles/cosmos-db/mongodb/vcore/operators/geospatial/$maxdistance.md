...
### Example 1: Find stores near a specific location

The query retrieves up to two stores within a 10 km radius of the given point coordinates [-77.9951, -62.7339].
