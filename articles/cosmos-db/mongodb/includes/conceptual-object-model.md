...
:::image type="complex" source="media/conceptual-object-model/resource-hiearchy.png" alt-text="Diagram of the Azure Cosmos DB DB hierarchy including accounts, databases, collections, and docs.":::
