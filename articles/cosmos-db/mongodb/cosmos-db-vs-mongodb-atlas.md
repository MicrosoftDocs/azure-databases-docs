...
| Compatible with MongoDB tools and drivers | Yes: v8 (private preview), v7, v6, v5, v4 | v7, v6, v5. Mongo Atlas does not support older versions such as v4 and soon v5.0 (EOL October 2024) |
...
| Dev/Test dedicated Clusters | Yes, with non-HA [vCore-based Azure Cosmos DB for MongoDB clusters](./vcore/introduction.md) saving you 50%. | No, Clusters must always be HA, causing you to pay for unecessary compute. |
...
| JSON schema for data governance controls | Yes, in preview | Yes |
