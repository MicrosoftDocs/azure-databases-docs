...
> [!TIP]
> Want to try the latest in Cosmos DB for MongoDB with no commitment? [Try our vCore tool](https://learn.microsoft.com/en-us/azure/cosmos-db/mongodb/vcore/free-tier) for free.
