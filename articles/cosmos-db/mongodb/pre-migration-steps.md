...
There are 3 ways to complete the pre-migration assessment, we recommend you to use the [Azure Cosmos DB for MongoDB Migration extension](#azure-cosmos-db-for-mongodb-migration-extension).
...
> [!NOTE]
> Database Migration Assistant is a legacy utility meant to assist you with the pre-migration steps. We recommend you to use the [Azure Cosmos DB for MongoDB Migration extension](#azure-cosmos-db-for-mongodb-migration-extension) for all pre-migration steps.
