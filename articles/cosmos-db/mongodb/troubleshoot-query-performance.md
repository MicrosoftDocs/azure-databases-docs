...
You can add new indexes at any time, with no effect on write or read availability. You can [track index transformation progress](../how-to-manage-indexing-policy.md#use-the-net-sdk).
