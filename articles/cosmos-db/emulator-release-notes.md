...
> [!WARNING]
> Previous versions of the emulator aren't supported by the product group.

### `2.14.20` (August 30, 2024)

- Fix emulator crash on ARM processors.
- Update Azure Cosmos DB Emulator background services to match the latest online functionality of the Azure Cosmos DB.

### `2.14.19` (August 6, 2024)
...
- [Develop locally using the Azure Cosmos DB emulator](how-to-develop-emulator.md)
