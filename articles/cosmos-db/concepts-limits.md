...
Azure Cosmos DB supports querying items using [SQL](/nosql/query/overview). The following table describes restrictions in query statements, such as the number of clauses or query length.
