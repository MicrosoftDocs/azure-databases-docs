...
> 
> It is highly recommended that the created Azure Key Vault Resource has [data replication enabled](azure/key-vault/general/disaster-recovery-guidance#data-replication) in order to ensure continous availability during unexpected regional outtages.
