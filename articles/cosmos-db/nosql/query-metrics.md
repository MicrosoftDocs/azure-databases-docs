...
Azure Cosmos DB provides a [API for NoSQL for querying data](/nosql/query/overview), without requiring schema or secondary indexes. This article provides the following information for developers:
...
## Next steps
* To learn about the supported SQL query operators and keywords, see [SQL query](/nosql/query/overview). 
