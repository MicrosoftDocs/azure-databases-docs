...
Azure Cosmos DB for NoSQL is optimized for JSON-based, scale-out workloads. When your scenario aligns with a different data model, follow the [Choose an API](../choose-api.md) migration guide to land on the right service:
