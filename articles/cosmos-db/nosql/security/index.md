...
With these identities, you can grant specific production applications or workloads fine-grained access to query, read, or manipulate data and resources in Azure Cosmos DB for NoSQL.
...
With the Azure SDK, the techniques used to access Azure Cosmos DB for NoSQL data programatically across many different scenarios:
