...
## Rule Description
Case-insensitive string searches can be costly. For example, case-sensitive `STARTSWITH` uses a precise index scan, but case-insensitive `STARTSWITH` uses an [expanded index scan]([Overview of Indexing - Azure Cosmos DB | Microsoft Learn](../../../index-overview.md#expanded-index-scan)). 
