...
- Set `disableLocalAuth = true` in the `databaseAccount` resource to [enforce RBAC as the only authentication method](../how-to-setup-rbac.md#enforcing-role-based-access-control-as-the-only-authentication-method).
