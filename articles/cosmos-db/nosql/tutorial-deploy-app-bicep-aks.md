...
- Set `disableLocalAuth = true` in the `databaseAccount` resource to [enforce RBAC as the only authentication method](security/how-to-connect-role-based-access-control.md#disable-key-based-authenticattion).
