...
This query is now able to be served from the index. Alternatively, you can use [computed properties](/cosmos-db/query/computed-properties) to index the results of system functions or complex calculations that would otherwise result in a full scan.
