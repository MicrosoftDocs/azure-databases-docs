...
1. In the code cell, add code to [execute a SQL query using the SDK](/nosql/query) storing the output of the query in a variable of type <xref:System.Collections.Generic.List%601> named **results**.
