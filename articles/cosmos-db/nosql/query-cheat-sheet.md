...
* For API for NoSQL queries, see [Query using the API for NoSQL](tutorial-query.md), [SQL queries for Azure Cosmos DB](/nosql/query/overview), and [SQL syntax reference](query/overview)
