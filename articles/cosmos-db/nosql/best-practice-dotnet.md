...
|<input type="checkbox"/>  |   End-to-end timeouts | To get end-to-end timeouts, you need to use both `RequestTimeout` and `CancellationToken` parameters. For more information, see [our timeout troubleshooting guide](troubleshoot-dotnet-sdk-request-timeout.md). |
...
## Best practices for multitenant applications
