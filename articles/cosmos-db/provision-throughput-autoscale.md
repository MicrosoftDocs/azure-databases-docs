...
> [!IMPORTANT]
> Use the Normalized RU Consumption metric in Azure Monitor to make programmatic scaling decisions. However, using Cosmos DB’s native autoscale is recommended to seamlessly take advantage of ongoing improvements and optimizations made to this feature. ReadThroughputAsync() API and Provisioned Throughput metric reflect billed throughput with a delay and shouldn't be used for scaling decisions. 
