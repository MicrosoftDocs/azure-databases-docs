...
> [!IMPORTANT]
> It's recommended to access Azure Cosmos DB using a system-assigned managed identity. If both the managed identity solution and cert based solution do not meet your needs, please use the Azure Key vault solution in this article.
