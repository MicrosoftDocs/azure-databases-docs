...
2. In the **Add container** page, enter the settings for the new container.
    ...
    |**Storage capacity**|Fixed (10 GB)|Enter *Fixed (10 GB)* for this application. If you select *Unlimited*, you'll have to create a `Shard Key`, which all items inserted will require.|
