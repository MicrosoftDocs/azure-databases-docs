---
title: Online container copy jobs
...
# Online container copy jobs in Azure Cosmos DB (preview)
...
Online container copy jobs can be [created and managed by using Azure CLI commands](how-to-container-copy.md).
