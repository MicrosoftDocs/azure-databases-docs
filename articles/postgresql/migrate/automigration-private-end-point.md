...
1. Delete the private endpoint associated with the single server deployment using [Azure CLI](/cli/azure/postgres/server/private-endpoint-connection?view=azure-cli-latest) or by following steps in Azure portal.
