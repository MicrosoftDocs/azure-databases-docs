...
:::image type="content" source="media/app-conversions-tutorial/model-selection.png" alt-text="Screenshot of model selection." lightbox="media/app-conversions-tutorial/model-selection.png":::
...
- Select **Convert Application**.
  :::image type="content" source="media/app-conversions-tutorial/start-application-migration.png" alt-text="Screenshot of convert Application." lightbox="media/app-conversions-tutorial/start-application-migration.png":::
...
- The report provides detailed results and recommended next steps for your conversion.
  :::image type="content" source="media/app-conversions-tutorial/conversion-report.png" alt-text="Screenshot of conversion Report." lightbox="media/app-conversions-tutorial/conversion-report.png":::

> **For comprehensive report guidance**: See the [Oracle to Azure Database for PostgreSQL application conversion generated reports (Preview)](app-conversions-reports.md) for detailed information on interpreting your conversion results, understanding file statuses, and planning your validation strategy.
...
> **Effective file comparison strategy**: See the [Oracle to Azure Database for PostgreSQL application conversion generated reports (Preview)](app-conversions-reports.md) for guidance on prioritizing which files to review first and how to focus your validation efforts.
...
> **Systematic validation approach**: Use the validation frameworks in the [Best practices for converting Oracle application code to Azure Database for PostgreSQL (Preview)](app-conversions-best-practices.md) to prioritize testing based on your Oracle integration complexity and conversion report results.
