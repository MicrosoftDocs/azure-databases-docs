...
1. Deploy and validate your Azure Database for PostgreSQL database.
1. Convert application code.
1. Perform functional validation and testing.
1. Optimize performance and database interactions.
...
:::image type="content" source="media/app-conversions-overview/architecture-diagram.png" alt-text="Screenshot of application Conversion Architecture." lightbox="media/app-conversions-overview/architecture-diagram.png":::
...
- **AI model access**: Claude Sonnet 4.6 or Claude Opus 4.6 (or similar code-centric model such as GPT-5.2-Codex; critical for high-quality conversion results)
...
1. **Access application conversion**: When the extension is installed, you can access the application conversion feature through the Migration Wizard interface after completing a schema conversion project.
...
:::image type="content" source="media/app-conversions-overview/model-selection.png" alt-text="Screenshot of model selection." lightbox="media/app-conversions-overview/model-selection.png":::
...
1. Navigate to the migration project folder structure:
   ...
   ```
1. Verify the project structure includes the necessary folders and files from schema conversion.
...
1. Copy your codebase into the migration project.
   ...
   :::image type="content" source="media/app-conversions-overview/app-code-inside-project.png" alt-text="Screenshot of application code folder inside your project.":::
...
1. Choose the database that has the context for your application:
...
1. Select **Convert Application**.
   :::image type="content" source="media/app-conversions-overview/start-application-migration.png" alt-text="Screenshot of convert Application." lightbox="media/app-conversions-overview/start-application-migration.png":::
...
1. The agent works through the generated TODO list systematically.
...
- File comparison views
  :::image type="content" source="media/app-conversions-overview/conversion-report.png" alt-text="Screenshot of conversion Report." lightbox="media/app-conversions-overview/conversion-report.png":::
...
- [What is Oracle to Azure Database for PostgreSQL schema conversion Preview?](../oracle-conversions-schema/schema-conversions-overview.md)
