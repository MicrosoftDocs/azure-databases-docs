---
title: Migrate Online, from a Google AlloyDB for PostgreSQL to Azure Database for PostgreSQL flexible server, Using the Migration Service in Azure
...
# Migrate online, from a Google AlloyDB for PostgreSQL server to Azure Database for PostgreSQL flexible server, with the migration service
