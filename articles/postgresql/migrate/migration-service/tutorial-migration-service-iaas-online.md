---
title: "Migrate Online, from an Azure VM or an On-Premises PostgreSQL to Azure Database for PostgreSQL flexible server, Using the Migration Service in Azure"
...
# Migrate online, from an Azure VM or an on-premises PostgreSQL server to Azure Database for PostgreSQL flexible server, with the migration service
