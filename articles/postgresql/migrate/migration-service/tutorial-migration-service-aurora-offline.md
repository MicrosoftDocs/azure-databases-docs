...
:::image type="content" source="media/tutorial-migration-service-aurora-offline/monitor-migration.png" alt-text="Screenshot of the monitor migration page." lightbox="media/tutorial-migration-service-aurora-offline/monitor-migration.png" lightbox="media/tutorial-migration-service-aurora-offline/monitor-migration.png":::
