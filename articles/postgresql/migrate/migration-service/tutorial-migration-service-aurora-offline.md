...
1. In the resource menu, select **Migration**.
    ...
    :::image type="content" source="media/tutorial-migration-service-aurora-offline/portal-offline-select-migration-pane.png" alt-text="Screenshot of the Migration page." lightbox="media/tutorial-migration-service-aurora-offline/portal-offline-select-migration-pane.png":::
...
1. Select **Create** to go through a wizard-based series of tabs to perform a migration to a flexible server from an Amazon Aurora PostgreSQL.
    ...
    :::image type="content" source="media/tutorial-migration-service-aurora-offline/portal-offline-create-migration.png" alt-text="Screenshot of the Setup tab which appears after selecting Create in the Migration page." lightbox="media/tutorial-migration-service-aurora-offline/portal-offline-create-migration.png":::
...
:::image type="content" source="media/tutorial-migration-service-aurora-offline/portal-offline-setup-migration-aurora.png" alt-text="Screenshot of the Setup tab after providing necessary details.":::
...
:::image type="content" source="media/tutorial-migration-service-aurora-offline/portal-offline-runtime-server-migration-aurora.png" alt-text="Screenshot of the Runtime server tab.":::
...
:::image type="content" source="media/tutorial-migration-service-aurora-offline/portal-offline-source-server-migration-aurora.png" alt-text="Screenshot of Source server migration tab.":::
...
:::image type="content" source="media/tutorial-migration-service-aurora-offline/portal-offline-target-server-migration-aurora.png" alt-text="Screenshot of the Target server migration tab.":::
...
:::image type="content" source="media/tutorial-migration-service-aurora-offline/portal-offline-databases-to-validate-or-migrate-migration-aurora.png" alt-text="Screenshot of the Databases to validate or migrate  migration tab.":::
...
:::image type="content" source="media/tutorial-migration-service-aurora-offline/portal-offline-summary-migration-aurora.png" alt-text="Screenshot of the Summary migration tab.":::
