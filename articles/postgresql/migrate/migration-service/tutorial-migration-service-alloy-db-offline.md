---
title: Migrate Offline, from a Google AlloyDB for PostgreSQL to Azure Database for PostgreSQL flexible server, Using the Migration Service in Azure
...
# Migrate offline, from a Google AlloyDB for PostgreSQL to Azure Database for PostgreSQL flexible server, with the migration service
