---
title: "Migration Runtime Server in Azure Database for PostgreSQL flexible server"
...
# Migration runtime server with the migration service in Azure Database for PostgreSQL flexible server
