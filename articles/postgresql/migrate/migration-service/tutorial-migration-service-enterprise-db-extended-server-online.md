---
title: Migrate Online, from an EDB Extended Server to Azure Database for PostgreSQL flexible server, Using the Migration Service in Azure
...
# Migrate online, from an EDB Extended server to Azure Database for PostgreSQL flexible server, with the migration service
