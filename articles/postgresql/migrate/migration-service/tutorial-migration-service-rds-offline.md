---
title: "Migrate Offline, from an Amazon RDS for PostgreSQL to Azure Database for PostgreSQL flexible server, Using the Migration Service in Azure"
...
# Migrate offline, from an Amazon RDS for PostgreSQL to Azure Database for PostgreSQL flexible server, with the migration service

This article guides you in migrating an Amazon RDS for PostgreSQL instance to Azure Database for PostgreSQL flexible server in offline mode.
