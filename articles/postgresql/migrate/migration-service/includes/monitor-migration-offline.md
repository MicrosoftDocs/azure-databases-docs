---
title: "Monitor the migration (offline)"
description: Monitor the migration offline.
author: apduvuri
...
:::image type="content" source="../media/tutorial-migration-service-iaas-offline/monitor-migration.png" alt-text="Screenshot of the monitor migration page." lightbox="../media/tutorial-migration-service-iaas-offline/monitor-migration.png":::
...
:::image type="content" source="../media/tutorial-migration-service-iaas-offline/details-migration.png" alt-text="Screenshot of the details showing validation and migration." lightbox="../media/tutorial-migration-service-iaas-offline/details-migration.png":::
