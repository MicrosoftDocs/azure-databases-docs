...
:::image type="content" source="../media/tutorial-migration-service-offline/monitor-migration.png" alt-text="Screenshot of the monitor migration page." lightbox="../media/tutorial-migration-service-offline/monitor-migration.png":::
