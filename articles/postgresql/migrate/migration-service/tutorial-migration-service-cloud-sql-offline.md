...
:::image type="content" source="media/tutorial-migration-service-cloud-sql-offline/setup-migration.png" alt-text="Screenshot of the Setup tab after providing necessary details.":::
...
:::image type="content" source="media/tutorial-migration-service-cloud-sql-offline/summary-migration.png" alt-text="Screenshot of the Summary migration tab.":::
...
:::image type="content" source="media/tutorial-migration-service-cloud-sql-offline/monitor-migration.png" alt-text="Screenshot of the monitor migration page." lightbox="media/tutorial-migration-service-aurora-offline/monitor-migration.png":::
