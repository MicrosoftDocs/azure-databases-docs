...
The following recommendations are now generally available for Azure Database for PostgreSQL servers as part of Defender CSPM, with additional assessments planned: 
