...
The following recommendations are now available in GA for Azure Database for PostgreSQL servers as part of Defender CSPM with additional assessments planned: 
