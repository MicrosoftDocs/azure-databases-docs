...
| [age](https://age.apache.org/) (Preview) provides graph database capabilities. | 1.6.0 <sup>*</sup> | <sup>*</sup> Set the `shared_preload_libraries` parameter to enable the corresponding libraries. |
