...
You can use Azure Service Health to [view notifications](/azure/service-health/service-health-planned-maintenance) about upcoming and performed scheduled maintenance on your Azure Database for PostgreSQL flexible server instance.
