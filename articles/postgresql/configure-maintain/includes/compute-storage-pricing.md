...
:::image type="content" source="../../extensions/media/compute-storage-pricing/new-server-estimated-costs.png" alt-text="Screenshot that shows the estimated monthly costs in the New Azure Database for PostgreSQL Flexible server wizard." lightbox="../../extensions/media/compute-storage-pricing/new-server-estimated-costs.png":::
