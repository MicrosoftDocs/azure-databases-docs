...
# Optimize query statistics collection on Azure Database for PostgreSQL 
...
- In the Azure portal, go to the [Azure Database for PostgreSQL flexible server resource management page and select the parameters blade](../parameters/concepts-parameters.md).
