...
| Documentation | [hot_standby](https://www.postgresql.org/docs/18/runtime-config-replication.html#GUC-HOT-STANDBY) |
...
| Parameter type | dynamic |
| Documentation | [max_standby_archive_delay](https://www.postgresql.org/docs/18/runtime-config-replication.html#GUC-MAX-STANDBY-ARCHIVE-DELAY) |
...
| Allowed values | `-1-2147483647` |
| Parameter type | dynamic |
| Documentation | [max_standby_streaming_delay](https://www.postgresql.org/docs/18/runtime-config-replication.html#GUC-MAX-STANDBY-STREAMING-DELAY) |
...
| Allowed values | |
| Parameter type | read-only |
| Documentation | [primary_conninfo](https://www.postgresql.org/docs/18/runtime-config-replication.html#GUC-PRIMARY-CONNINFO) |
...
| Allowed values | |
| Parameter type | read-only |
| Documentation | [primary_slot_name](https://www.postgresql.org/docs/18/runtime-config-replication.html#GUC-PRIMARY-SLOT-NAME) |
...
| Allowed values | `off` |
| Parameter type | read-only |
| Documentation | [wal_receiver_create_temp_slot](https://www.postgresql.org/docs/18/runtime-config-replication.html#GUC-WAL-RECEIVER-CREATE-TEMP-SLOT) |
...
| Parameter type | dynamic |
| Documentation | [wal_receiver_status_interval](https://www.postgresql.org/docs/18/runtime-config-replication.html#GUC-WAL-RECEIVER-STATUS-INTERVAL) |
...
| Allowed values | `0-2147483647` |
| Parameter type | dynamic |
| Documentation | [wal_receiver_timeout](https://www.postgresql.org/docs/18/runtime-config-replication.html#GUC-WAL-RECEIVER-TIMEOUT) |
...
| Allowed values | `5000` |
| Parameter type | read-only |
| Documentation | [wal_retrieve_retry_interval](https://www.postgresql.org/docs/18/runtime-config-replication.html#GUC-WAL-RETRIEVE-RETRY-INTERVAL) |
