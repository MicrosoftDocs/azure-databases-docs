...
# Migrate or replicate from Premium SSD to Premium SSDv2 in Azure Database for PostgreSQL flexible server

This article provides step-by-step instructions to migrate from Premium SSD to Premium SSDv2 by using replication in an Azure Database for PostgreSQL flexible server.
...
1. Optionally, once the promotion is complete, you can point your virtual endpoint pairs from the Premium SSD flexible server to the new Premium SSD v2 server.
