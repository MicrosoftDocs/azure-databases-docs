...
6. A new deployment is launched to create your new Azure Database for PostgreSQL flexible server with Premium SSD v2 storage type with the latest data using replication.
...
10. Optionally, Once the promotion is complete, you can re-point your virtual endpoints from Premium SSD flexible server to the new Premium SSD v2 server.
