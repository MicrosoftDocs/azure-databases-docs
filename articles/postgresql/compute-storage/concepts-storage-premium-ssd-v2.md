...
-  Although CMK, geo-redundant backups, and read replicas are each supported, enabling geo-redundant backups with CMK, read replicas with CMK isn't currently supported.
