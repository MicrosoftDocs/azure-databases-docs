...
| Documentation | [enable_async_append](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-ASYNC-APPEND) |
...
| Documentation | [enable_bitmapscan](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-BITMAPSCAN) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [enable_hashagg](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-HASHAGG) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [enable_hashjoin](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-HASHJOIN) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [enable_incremental_sort](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-INCREMENTAL-SORT) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [enable_indexonlyscan](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-INDEXONLYSCAN) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [enable_indexscan](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-INDEXSCAN) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [enable_material](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-MATERIAL) |
...
| Allowed values | `on` |
| Parameter type | read-only |
| Documentation | [enable_memoize](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-MEMOIZE) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [enable_mergejoin](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-MERGEJOIN) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [enable_nestloop](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-NESTLOOP) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [enable_parallel_append](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-PARALLEL-APPEND) |
...
| Allowed values | `on` |
| Parameter type | read-only |
| Documentation | [enable_parallel_hash](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-PARALLEL-HASH) |
...
| Allowed values | `on` |
| Parameter type | read-only |
| Documentation | [enable_partition_pruning](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-PARTITION-PRUNING) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [enable_partitionwise_aggregate](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-PARTITIONWISE-AGGREGATE) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [enable_partitionwise_join](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-PARTITIONWISE-JOIN) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [enable_seqscan](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-SEQSCAN) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [enable_sort](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-SORT) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [enable_tidscan](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-ENABLE-TIDSCAN) |
