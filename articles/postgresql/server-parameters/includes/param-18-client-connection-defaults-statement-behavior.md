...
| Documentation | [bytea_output](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-BYTEA-OUTPUT) |
...
| Parameter type | dynamic |
| Documentation | [check_function_bodies](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-CHECK-FUNCTION-BODIES) |
...
| Parameter type | dynamic |
| Documentation | [client_min_messages](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-CLIENT-MIN-MESSAGES) |
...
| Documentation | [createrole_self_grant](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-CREATEROLE-SELF-GRANT) |
...
| Allowed values | `heap` |
| Parameter type | read-only |
| Documentation | [default_table_access_method](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-DEFAULT-TABLE-ACCESS-METHOD) |
...
| Parameter type | dynamic |
| Documentation | [default_tablespace](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-DEFAULT-TABLESPACE) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [default_transaction_deferrable](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-DEFAULT-TRANSACTION-DEFERRABLE) |
...
| Parameter type | dynamic |
| Documentation | [default_transaction_isolation](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-DEFAULT-TRANSACTION-ISOLATION) |
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [default_transaction_read_only](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-DEFAULT-TRANSACTION-READ-ONLY) |
...
| Parameter type | dynamic |
| Documentation | [gin_pending_list_limit](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-GIN-PENDING-LIST-LIMIT) |
...
| Parameter type | dynamic |
| Documentation | [idle_in_transaction_session_timeout](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-IDLE-IN-TRANSACTION-SESSION-TIMEOUT) |
...
| Allowed values | `0-2147483647` |
| Parameter type | dynamic |
| Documentation | [idle_session_timeout](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-IDLE-SESSION-TIMEOUT) |
...
| Allowed values | `0-2147483647` |
| Parameter type | dynamic |
| Documentation | [lock_timeout](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-LOCK-TIMEOUT) |
...
| Allowed values | |
| Parameter type | read-only |
| Documentation | [restrict_nonsystem_relation_kind](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-RESTRICT-NONSYSTEM-RELATION-KIND) |
...
| Parameter type | dynamic |
| Documentation | [search_path](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-SEARCH-PATH) |
...
| Parameter type | dynamic |
| Documentation | [session_replication_role](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-SESSION-REPLICATION-ROLE) |
...
| Allowed values | `0-2147483647` |
| Parameter type | dynamic |
| Documentation | [statement_timeout](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-STATEMENT-TIMEOUT) |
...
| Allowed values | `[A-Za-z._]*` |
| Parameter type | dynamic |
| Documentation | [temp_tablespaces](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-TEMP-TABLESPACES) |
...
| Allowed values | `off` |
| Parameter type | read-only |
| Documentation | [transaction_deferrable](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-TRANSACTION-DEFERRABLE) |
...
| Parameter type | read-only |
| Documentation | [transaction_isolation](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-TRANSACTION-ISOLATION) |
...
| Allowed values | `off` |
| Parameter type | read-only |
| Documentation | [transaction_read_only](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-TRANSACTION-READ-ONLY) |
...
| Allowed values | `0-2147483647` |
| Parameter type | dynamic |
| Documentation | [transaction_timeout](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-TRANSACTION-TIMEOUT) |
...
| Parameter type | dynamic |
| Documentation | [vacuum_failsafe_age](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-VACUUM-FAILSAFE-AGE) |
...
| Parameter type | dynamic |
| Documentation | [vacuum_freeze_min_age](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-VACUUM-FREEZE-MIN-AGE) |
...
| Parameter type | dynamic |
| Documentation | [vacuum_freeze_table_age](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-VACUUM-FREEZE-TABLE-AGE) |
...
| Allowed values | `0-2100000000` |
| Parameter type | dynamic |
| Documentation | [vacuum_multixact_failsafe_age](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-VACUUM-FREEZE-TABLE-AGE) |
...
| Allowed values | `0-1000000000` |
| Parameter type | dynamic |
| Documentation | [vacuum_multixact_freeze_min_age](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-VACUUM-MULTIXACT-FREEZE-MIN-AGE) |
...
| Allowed values | `0-2000000000` |
| Parameter type | dynamic |
| Documentation | [vacuum_multixact_freeze_table_age](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-VACUUM-MULTIXACT-FREEZE-TABLE-AGE) |
...
| Parameter type | dynamic |
| Documentation | [xmlbinary](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-XMLBINARY) |
...
| Parameter type | dynamic |
| Documentation | [xmloption](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-XMLOPTION) |
