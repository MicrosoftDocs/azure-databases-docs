...
| Documentation | [dynamic_library_path](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-DYNAMIC-LIBRARY-PATH) |
...
| Documentation | [gin_fuzzy_search_limit](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-GIN-FUZZY-SEARCH-LIMIT) |
