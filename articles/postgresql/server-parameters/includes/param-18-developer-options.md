...
| Documentation | [allow_in_place_tablespaces](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-ALLOW-IN-PLACE-TABLESPACES) |
...
| Allowed values | `off` |
| Parameter type | read-only |
| Documentation | [allow_system_table_mods](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-ALLOW-SYSTEM-TABLE-MODS) |
...
| Allowed values | |
| Parameter type | read-only |
| Documentation | [backtrace_functions](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-BACKTRACE-FUNCTIONS) |
...
| Allowed values | `0` |
| Parameter type | read-only |
| Documentation | [debug_discard_caches](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-DEBUG-DISCARD-CACHES) |
...
| Allowed values | |
| Parameter type | read-only |
| Documentation | [debug_io_direct](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-DEBUG-IO-DIRECT) |
...
| Parameter type | read-only |
| Documentation | [debug_logical_replication_streaming](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-DEBUG-LOGICAL-REPLICATION-STREAMING) |
...
| Documentation | [debug_parallel_query](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-DEBUG-PARALLEL-QUERY) |
...
| Allowed values | `off` |
| Parameter type | read-only |
| Documentation | [ignore_checksum_failure](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-IGNORE-CHECKSUM-FAILURE) |
...
| Allowed values | `off` |
| Parameter type | read-only |
| Documentation | [ignore_invalid_pages](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-IGNORE-INVALID-PAGES) |
...
| Allowed values | `off` |
| Parameter type | read-only |
| Documentation | [ignore_system_indexes](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-IGNORE-SYSTEM-INDEXES) |
...
| Allowed values | `off` |
| Parameter type | read-only |
| Documentation | [jit_debugging_support](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-JIT-DEBUGGING-SUPPORT) |
...
| Allowed values | `off` |
| Parameter type | read-only |
| Documentation | [jit_dump_bitcode](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-JIT-DUMP-BITCODE) |
...
| Allowed values | `on` |
| Parameter type | read-only |
| Documentation | [jit_expressions](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-JIT-EXPRESSIONS) |
...
| Allowed values | `off` |
| Parameter type | read-only |
| Documentation | [jit_profiling_support](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-JIT-PROFILING-SUPPORT) |
...
| Allowed values | `on` |
| Parameter type | read-only |
| Documentation | [jit_tuple_deforming](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-JIT-TUPLE-DEFORMING) |
...
| Allowed values | `0` |
| Parameter type | read-only |
| Documentation | [post_auth_delay](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-POST-AUTH-DELAY) |
...
| Allowed values | `0` |
| Parameter type | read-only |
| Documentation | [pre_auth_delay](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-PRE-AUTH-DELAY) |
...
| Allowed values | `on` |
| Parameter type | read-only |
| Documentation | [remove_temp_files_after_crash](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-REMOVE-TEMP-FILES-AFTER-CRASH) |
...
| Allowed values | `off` |
| Parameter type | read-only |
| Documentation | [send_abort_for_crash](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-SEND-ABORT-FOR-CRASH) |
...
| Allowed values | `off` |
| Parameter type | read-only |
| Documentation | [trace_notify](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-TRACE-NOTIFY) |
...
| Allowed values | `off` |
| Parameter type | read-only |
| Documentation | [trace_sort](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-TRACE-SORT) |
...
| Allowed values | |
| Parameter type | read-only |
| Documentation | [wal_consistency_checking](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-WAL-CONSISTENCY-CHECKING) |
...
| Allowed values | `off` |
| Parameter type | read-only |
| Documentation | [zero_damaged_pages](https://www.postgresql.org/docs/18/runtime-config-developer.html#GUC-ZERO-DAMAGED-PAGES) |
