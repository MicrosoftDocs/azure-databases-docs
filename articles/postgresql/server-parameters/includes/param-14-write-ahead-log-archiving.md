...
| Documentation | [archive_command](https://www.postgresql.org/docs/14/runtime-config-wal.html#GUC-ARCHIVE-COMMAND) |
...
| Parameter type | read-only |
| Documentation | [archive_mode](https://www.postgresql.org/docs/14/runtime-config-wal.html#GUC-ARCHIVE-MODE) |
...
| Allowed values | `300` |
| Parameter type | read-only |
| Documentation | [archive_timeout](https://www.postgresql.org/docs/14/runtime-config-wal.html#GUC-ARCHIVE-TIMEOUT) |
