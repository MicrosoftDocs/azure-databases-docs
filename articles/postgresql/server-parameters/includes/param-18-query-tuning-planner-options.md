...
| Documentation | [constraint_exclusion](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-CONSTRAINT-EXCLUSION) |
...
| Allowed values | `0-1` |
| Parameter type | dynamic |
| Documentation | [cursor_tuple_fraction](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-CURSOR-TUPLE-FRACTION) |
...
| Parameter type | dynamic |
| Documentation | [default_statistics_target](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-DEFAULT-STATISTICS-TARGET) |
...
| Parameter type | dynamic |
| Documentation | [from_collapse_limit](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-FROM-COLLAPSE-LIMIT) |
...
| Parameter type | dynamic |
| Documentation | [jit](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-JIT) |
...
| Allowed values | `1-2147483647` |
| Parameter type | dynamic |
| Documentation | [join_collapse_limit](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-JOIN-COLLAPSE-LIMIT) |
...
| Parameter type | dynamic |
| Documentation | [plan_cache_mode](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-PLAN-CACHE-MODE) |
...
| Documentation | [recursive_worktable_factor](https://www.postgresql.org/docs/18/runtime-config-query.html#GUC-RECURSIVE-WORKTABLE-FACTOR) |
