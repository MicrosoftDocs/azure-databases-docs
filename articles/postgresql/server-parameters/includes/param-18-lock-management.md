...
| Documentation | [deadlock_timeout](https://www.postgresql.org/docs/18/runtime-config-locks.html#GUC-DEADLOCK-TIMEOUT) |
...
| Documentation | [max_locks_per_transaction](https://www.postgresql.org/docs/18/runtime-config-locks.html#GUC-MAX-LOCKS-PER-TRANSACTION) |
...
| Parameter type | dynamic |
| Documentation | [max_pred_locks_per_page](https://www.postgresql.org/docs/18/runtime-config-locks.html#GUC-MAX-PRED-LOCKS-PER-PAGE) |
...
| Parameter type | dynamic |
| Documentation | [max_pred_locks_per_relation](https://www.postgresql.org/docs/18/runtime-config-locks.html#GUC-MAX-PRED-LOCKS-PER-RELATION) |
...
| Documentation | [max_pred_locks_per_transaction](https://www.postgresql.org/docs/18/runtime-config-locks.html#GUC-MAX-PRED-LOCKS-PER-TRANSACTION) |
