...
| Documentation | [bgwriter_delay](https://www.postgresql.org/docs/13/runtime-config-resource.html#GUC-BGWRITER-DELAY) |
...
| Parameter type | dynamic |
| Documentation | [bgwriter_flush_after](https://www.postgresql.org/docs/13/runtime-config-resource.html#GUC-BGWRITER-FLUSH-AFTER) |
...
| Parameter type | dynamic |
| Documentation | [bgwriter_lru_maxpages](https://www.postgresql.org/docs/13/runtime-config-resource.html#GUC-BGWRITER-LRU-MAXPAGES) |
...
| Allowed values | `0-10` |
| Parameter type | dynamic |
| Documentation | [bgwriter_lru_multiplier](https://www.postgresql.org/docs/13/runtime-config-resource.html#GUC-BGWRITER-LRU-MULTIPLIER) |
