...
| Documentation | [config_file](https://www.postgresql.org/docs/18/runtime-config-file-locations.html#GUC-CONFIG-FILE) |
...
| Parameter type | read-only |
| Documentation | [data_directory](https://www.postgresql.org/docs/18/runtime-config-file-locations.html#GUC-DATA-DIRECTORY) |
...
| Allowed values | |
| Parameter type | read-only |
| Documentation | [external_pid_file](https://www.postgresql.org/docs/18/runtime-config-file-locations.html#GUC-EXTERNAL-PID-FILE) |
...
| Parameter type | read-only |
| Documentation | [hba_file](https://www.postgresql.org/docs/18/runtime-config-file-locations.html#GUC-HBA-FILE) |
...
| Parameter type | read-only |
| Documentation | [ident_file](https://www.postgresql.org/docs/18/runtime-config-file-locations.html#GUC-IDENT-FILE) |
