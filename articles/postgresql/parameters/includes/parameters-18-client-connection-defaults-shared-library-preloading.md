...
| Documentation | [jit_provider](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-JIT-PROVIDER) |
...
| Allowed values | |
| Parameter type | read-only |
| Documentation | [local_preload_libraries](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-LOCAL-PRELOAD-LIBRARIES) |
...
| Documentation | [session_preload_libraries](https://www.postgresql.org/docs/18/runtime-config-client.html#GUC-SESSION-PRELOAD-LIBRARIES) |
...
| Allowed values | `age,anon,auto_explain,azure_storage,credcheck,pg_cron,pg_duckdb,pg_hint_plan,pg_ivm,pg_partman_bgw,pg_prewarm,pg_squeeze,pg_stat_statements,pgaudit,pglogical,plpgsql_check,timescaledb,wal2json` |
