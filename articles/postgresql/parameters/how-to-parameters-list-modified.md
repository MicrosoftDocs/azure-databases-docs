---
title: List parameters with modified defaults in Azure Database for PostgreSQL Flexible Server
...
#customer intent: As a user, I want to list all parameters with modified defaults on my Azure Database for PostgreSQL flexible server, so that I can review which settings deviate from the defaults.
author: jasomaning
...
# List parameters with modified defaults in Azure Database for PostgreSQL flexible server
