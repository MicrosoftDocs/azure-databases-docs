---
title: Parameters
description: Learn about the parameters for an Azure Database for PostgreSQL flexible server instance.
author: jasomaning
...
# Parameter in Azure Database for PostgreSQL flexible server 
...
Both, **database engine** and **non-database engine** parameters can be configured at the server level. For more information, see [set the value of one or more parameters](how-to-parameters-set-value.md).
