---
title: Revert all parameters to their defaults
description: This article describes how to revert all parameters to their defaults of an Azure Database for PostgreSQL flexible server.
author: jasomaning
...
ms.topic: how-to
#customer intent: As a user, I want to learn how to revert all parameters to their defaults of an Azure Database for PostgreSQL.
---

# Revert all parameters to their defaults

This article provides step-by-step instructions to revert all parameters to their defaults of an Azure Database for PostgreSQL flexible server.

## Steps to revert all parameters to their defaults
...
4. Select **Reset all to default**.
    ...
    :::image type="content" source="./media/how-to-configure-parameters/reset-all-to-default.png" alt-text="Screenshot that shows the Reset all to default button." lightbox="./media/how-to-configure-parameters/reset-all-to-default.png":::
...
You can revert the value of all read-write parameters to their defaults via the [az postgres flexible-parameter set](/cli/azure/postgres/flexible-server/parameter#az-postgres-flexible-parameter-set) command.

```azurecli-interactive
parameters_to_reset=$(az postgres flexible-parameter list \
