...
[AKS](/azure/aks/intro-kubernetes) is a managed Kubernetes service that you use to quickly deploy and manage clusters. [What is Azure Database for PostgreSQL?](../overview.md) is a fully managed database service designed to provide more granular control and flexibility over database management functions and configuration settings.
...
Use the [az aks create](/cli/azure/aks#az-aks-create) command to create an AKS cluster. The following example creates a cluster named *djangoappcluster* with one node. The creation of the cluster takes several minutes to complete.
...
- [List all server parameters](../parameters/how-to-parameters-list-all.md)
