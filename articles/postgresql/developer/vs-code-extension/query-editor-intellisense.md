...
- In **Object Explorer**, right-click a database node and select **New Query**.
...
After you run a query, results appear in the **Query Results** panel below the editor. The panel has up to three tabs depending on the query type.

# [Visual Studio Code](#tab/vscode)

:::image type="content" source="./media/screenshots/vscode/results-grid/default.png" alt-text="Query Results panel with data grid" lightbox="./media/screenshots/vscode/results-grid/default.png":::

# [Cursor](#tab/cursor)

:::image type="content" source="./media/screenshots/cursor/results-grid/default.png" alt-text="Query Results panel with data grid" lightbox="./media/screenshots/cursor/results-grid/default.png":::
...
:::image type="content" source="./media/screenshots/vscode/results-grid/rich-join-data.png" alt-text="Query Results panel showing joined model and provider data in the results grid" lightbox="./media/screenshots/vscode/results-grid/rich-join-data.png":::

# [Cursor](#tab/cursor)

:::image type="content" source="./media/screenshots/cursor/results-grid/rich-join-data.png" alt-text="Query Results panel showing joined model and provider data in the results grid" lightbox="./media/screenshots/cursor/results-grid/rich-join-data.png":::
...
When you run an `EXPLAIN` or `EXPLAIN ANALYZE` query, a **Query Plan** tab appears alongside **Results** and **Messages**. Select this tab to open the built-in execution plan visualizer, or select the **Visualize Query Plan** button in the results toolbar.

You can also run `PGSQL: Visualize Query Plan` from the Command Palette to visualize the plan for the current query.
...
:::image type="content" source="./media/screenshots/vscode/query-history/query-history.png" alt-text="Query History view showing previously executed queries" lightbox="./media/screenshots/vscode/query-history/query-history.png":::

# [Cursor](#tab/cursor)

:::image type="content" source="./media/screenshots/cursor/query-history/query-history.png" alt-text="Query History view showing previously executed queries" lightbox="./media/screenshots/cursor/query-history/query-history.png":::
