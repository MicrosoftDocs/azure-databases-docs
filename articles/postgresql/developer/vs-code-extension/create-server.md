...
- **For an Azure HorizonDB cluster:** An Azure account with an active subscription and access to the HorizonDB Preview.

## Open the Create New Server hub

1. In the **PostgreSQL** activity bar, locate **Object Explorer**.
1. Select the **Create New Server** button at the top of Object Explorer, or run `pgsql.createNewServer` from the Command Palette.

   You can also right-click a server group in Object Explorer and select **Create New Server**.

# [Visual Studio Code](#tab/vscode)

:::image type="content" source="./media/screenshots/vscode/object-explorer/create-server-toolbar.png" alt-text="Object Explorer toolbar with Create New Server button" lightbox="./media/screenshots/vscode/object-explorer/create-server-toolbar.png":::

# [Cursor](#tab/cursor)

:::image type="content" source="./media/screenshots/cursor/object-explorer/create-server-toolbar.png" alt-text="Object Explorer toolbar with Create New Server button" lightbox="./media/screenshots/cursor/object-explorer/create-server-toolbar.png":::
...
:::image type="content" source="./media/screenshots/vscode/create-server/create-server-hub.png" alt-text="Create New PostgreSQL Server hub with provider cards" lightbox="./media/screenshots/vscode/create-server/create-server-hub.png":::

# [Cursor](#tab/cursor)

:::image type="content" source="./media/screenshots/cursor/create-server/create-server-hub.png" alt-text="Create New PostgreSQL Server hub with provider cards" lightbox="./media/screenshots/cursor/create-server/create-server-hub.png":::
...
- **Easy Management** — Start, stop, or remove your PostgreSQL container anytime.
...
:::image type="content" source="./media/screenshots/vscode/create-server/docker-config-form.png" alt-text="Docker server configuration form" lightbox="./media/screenshots/vscode/create-server/docker-config-form.png":::

# [Cursor](#tab/cursor)

:::image type="content" source="./media/screenshots/cursor/create-server/docker-config-form.png" alt-text="Docker server configuration form" lightbox="./media/screenshots/cursor/create-server/docker-config-form.png":::
...
A progress indicator titled **Creating a Local Docker Server...** appears while the container initializes. When the container is ready, the server appears in Object Explorer and you can start querying immediately.
...
- **Easy Server Management** — Manage lifecycle, performance, and configuration without leaving the editor.
...
| Setting | Description |
|---|---|
| **PostgreSQL Version** | The major PostgreSQL version to deploy. Available versions: 18, 17, 16, 15, and 14. Defaults to 18. Available versions may vary by region. |
...
| Setting | Description |
|---|---|
| **Administrator username** | Login name for the PostgreSQL admin account (for example, `pgadmin`). Must start with a letter and contain only letters, numbers, and underscores. Cannot use reserved names such as `admin`, `root`, `guest`, or names starting with `pg_`. |
...
1. Select the **I acknowledge that creating this server may incur charges** checkbox.
...
> [!NOTE]
> Azure HorizonDB is in Preview. Availability depends on your Azure subscription and region.
...
:::image type="content" source="./media/screenshots/vscode/create-server/horizon-config-form.png" alt-text="HorizonDB cluster configuration form with project details, cluster settings, vCores slider, authentication, and AI capabilities" lightbox="./media/screenshots/vscode/create-server/horizon-config-form.png":::

# [Cursor](#tab/cursor)

:::image type="content" source="./media/screenshots/cursor/create-server/horizon-config-form.png" alt-text="HorizonDB cluster configuration form with project details, cluster settings, vCores slider, authentication, and AI capabilities" lightbox="./media/screenshots/cursor/create-server/horizon-config-form.png":::
...
> [!NOTE]
> The **AI capabilities** section is a preview experience and may not appear for every environment or cluster configuration. If the section isn't visible, continue with the standard HorizonDB cluster settings and deployment steps.
...
1. Expand the server node in Object Explorer.
