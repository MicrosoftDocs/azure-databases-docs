...
The following video demonstrates the use of generative AI with Azure Database for PostgreSQL and the [`pgvector` extension](../extensions/../extensions/how-to-use-pgvector.md). It can help you understand the concepts in this article.
