...
The following video demonstrates the use of generative AI with Azure Database for PostgreSQL and the [`pgvector` extension](../extension-module/how-to-use-pgvector.md), which can help you understand the concepts in this article.
...
PostgreSQL can gain the capabilities of a vector database with the help of the [`pgvector` extension](../extension-module/how-to-use-pgvector.md).
