...
This article shows you how to use the integrated [vector database](../configure-maintain/how-to-use-pgvector.md) in Azure Database for PostgreSQL to store and manage documents in collections with LangChain. It also shows you how to create indices and perform vector search queries by using nearest-neighbor algorithms such as cosine distance, L2 distance (Euclidean distance), and inner product to locate documents close to the query vectors.
...
See [Enable and use pgvector in Azure Database for PostgreSQL](../configure-maintain/how-to-use-pgvector.md).
