...
1. Select the **Enable high availability** checkbox to enable the option. Once selected, the **Zone redundant** option is automatically enabled by default, as it is the recommended configuration.
