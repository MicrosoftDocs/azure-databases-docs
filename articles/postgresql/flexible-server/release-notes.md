...
- Support for Virtual Network (virtual network) [private DNS zone](./concepts-networking.md#private-access-vnet-integration).
...
- [Create an Azure Database for PostgreSQL - Flexible Server using Azure CLI](./quickstart-create-server-cli.md)
