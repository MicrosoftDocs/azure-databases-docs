...
- Support for pg_signal_autovacuum_worker role for PostgreSQL versions 15 and higher [pg_signal_autovacuum_worker](how-to-autovacuum-tuning.md#Troubleshooting-guides)
