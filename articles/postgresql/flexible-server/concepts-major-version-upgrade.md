...
- If you are performing the upgrade from PG11 to a higher version, you will need to ensure that [SCRAM authentication](./security-connect-scram.md#configure-scram-authentication) is configured in your flexible server.
