...
This quickstart uses the resources created in the [Create an Azure Database for PostgreSQL flexible server](quickstart-create-server.md) as a starting point.
