...
| --- | --- | --- |
| 2024-11-01-preview | Preview | Index tuning<br>Added source types for migration<br>PG 17 support<br>UltraSSD_LRS storage type support<br>Citus on Flex cluster support<br> |
