...
## Related content
- [How to enable and use azure_local_ai on Azure Database for PostgreSQL - Flexible Server](how-to-use-pgvector.md)
- [How to enable and use pgvector on Azure Database for PostgreSQL - Flexible Server](generative-ai-azure-local-ai.md)