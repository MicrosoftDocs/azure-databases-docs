...
Customers cannot directly grant the necessary permissions. If you need to be able to run `pgstattuple` to access objects under the `pg_toast` schema, please proceed to [create an Azure support request](https://learn.microsoft.com/azure/azure-portal/supportability/how-to-create-azure-support-request).
