---
title: Data encryption in Azure Database for PostgreSQL - Flexible Server
...
# Data encryption in Azure Database for PostgreSQL - Flexible Server
...
For keys generated by Key Vault, you can [configure cryptographic key autorotation in Azure Key Vault](/azure/key-vault/keys/how-to-configure-key-rotation). If you enable autorotation, then you must use a [version-less CMK (preview)](#version-less-cmk-preview) for data encryption in Azure Database for PostgreSQL flexible server to take advantage of this feature.
