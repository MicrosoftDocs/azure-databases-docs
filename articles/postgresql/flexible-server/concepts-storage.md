...
2. If the server is marked as read only because disk full condition, you can delete the data that is no longer required, to do this you can execute the below command to change the mode to read-write mode and once that is done you can execute delete command.
```sql
