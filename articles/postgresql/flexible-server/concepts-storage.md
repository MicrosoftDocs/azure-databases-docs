...
5% = 1.6 GiB
Read-only mode is triggered when free space drops below 1.6 GiB


8 TiB disk (8192 GiB):

5% = 409.6 GiB
Since 5 GiB is already below the 5% threshold, the server switches to read-only mode when free space falls below 5 GiB
