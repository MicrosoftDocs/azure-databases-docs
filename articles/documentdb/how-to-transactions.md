...
description: Support atomicity, consistency, isolation, and durability with transactions in Azure DocumentDB.
author: gahl-levy
ms.author: gahllevy
ms.topic: how-to
ms.date: 08/28/2023
...
# Group multiple operations in transactions in Azure DocumentDB
...
The ACID principles in database management ensure transactions are processed reliably. Azure DocumentDB implements these principles, enabling you to create transactions for multiple operations.
