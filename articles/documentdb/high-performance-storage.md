...
- High performance storage can get the maximum performance for your selected compute/storage combination for the fixed price per 1 GiB of storage / month. For more information, see [Azure DocumentDB pricing](https://azure.microsoft.com/en-us/pricing/details/document-db/).
