---
title:  Sharding for horizontal scalability in Azure DocumentDB
description: Logical sharding for horizontal scale in Azure DocumentDB.
author: abinav2307
ms.author: abramees
...
- Sharding in Azure DocumentDB isn't required unless the collection's storage and transaction volumes can exceed the capacity of a single physical shard. For instance, the service provides 32 TB disks per shard. If a collection requires more than 32 TB, it should be sharded.
