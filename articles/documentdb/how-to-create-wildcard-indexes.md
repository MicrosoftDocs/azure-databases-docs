---
title:  Wildcard indexes in Azure DocumentDB
description: Sample to create wildcard indexes in Azure DocumentDB.
author: abinav2307
ms.author: abramees
ms.topic: how-to
ms.date: 7/30/2024
...
# Create wildcard indexes in Azure DocumentDB
...
This sample describes a simple workaround to minimize the effort needed to create individual indexes until wildcard indexing is generally available in Azure DocumentDB.
...
- Azure DocumentDB cluster connection string with the username and password used when the cluster was provisioned
- The Azure DocumentDB database
