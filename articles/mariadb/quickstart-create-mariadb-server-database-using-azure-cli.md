...
Create an [Azure resource group](/azure/azure-resource-manager/management/overview) by using the [az group create](/cli/azure/group#az-group-create) command. A resource group is a logical container in which Azure resources are deployed and managed as a group.
