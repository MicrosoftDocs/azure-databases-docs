...
- One or more compute replicas, one is a writable primary, the rest are readable standby replicas.
...
- [Quickstart: Create an Azure HorizonDB Cluster](configure-maintain/quickstart-create-server.md)
- [Backup and restore in Azure HorizonDB](backup-restore/concepts-backup-restore.md)
- [What is PostgreSQL Extension for Visual Studio Code with Azure HorizonDB](development/vs-code-extension/vs-code-overview.md)
