...
To purchase Azure HorizonDB reserved capacity, you need to specify the Azure region, deployment type, performance tier, and term.
...
A reservation doesn't cover software, networking, or storage charges associated with the Azure HorizonDB. At the end of the reservation term, the billing benefit expires, and the vCores that Azure HorizonDB use are billed at the pay-as-you go price. Reservations don't automatically renew. For pricing information, see the [Azure HorizonDB reserved capacity offering](https://azure.microsoft.com/pricing/details/postgresql/).
