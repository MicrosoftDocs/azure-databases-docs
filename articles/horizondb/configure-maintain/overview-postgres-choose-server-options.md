...
description: Provides guidelines for choosing the right Azure HorizonDB flexible server instance hosting option.
...
# Choose the right Azure HorizonDB  hosting option in Azure
...
- {[Azure HorizonDB](../flexible-server/overview.md)}
