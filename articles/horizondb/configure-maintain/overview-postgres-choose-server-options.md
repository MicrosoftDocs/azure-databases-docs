---
title: Choose Hosting Type in Azure HorizonDB
description: Provides guidelines for choosing the right Azure HorizonDB instance hosting option.
...
# Choose hosting type in Azure HorizonDB
...
With Azure HorizonDB, you can continue to administer your database. But you no longer need to manage the database engine, the operating system, or the hardware. Examples of items you can continue to administer include:
