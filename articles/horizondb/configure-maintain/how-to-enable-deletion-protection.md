...
description: This article describes how to enable deletion protection in an Azure HorizonDB flexible server instance using Azure Resource Manager locks.
...
ms.topic: how-to
# customer intent: As a user, I want to learn how to prevent accidental deletion of an Azure HorizonDB flexible server instance by enabling a CanNotDelete lock.
---

# Protect Azure HorizonDB with Resource Locks
...
## Prerequisites
- An existing Azure HorizonDB flexible server instance within your subscription.
