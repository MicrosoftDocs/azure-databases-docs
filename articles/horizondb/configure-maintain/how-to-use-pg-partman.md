...
description: Learn how to enable and use pg_partman on Azure HorizonDB flexible server to optimize database performance and improve query speed.
...
# Enable and use pg_partman on Azure HorizonDB 

In this article, you learn how to optimize Azure HorizonDB flexible server by using the PostgreSQL Partition Manager (`pg_partman`) extension.
...
In this article, you use `pg_partman` to create range-based partitions of tables in your Azure HorizonDB flexible server.
