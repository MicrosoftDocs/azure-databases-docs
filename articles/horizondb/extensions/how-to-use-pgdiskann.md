...
To learn about other options to configure these parameters in Azure HorizonDB flexible server, see [Configure server parameters](../server-parameters/how-to-server-parameters-list-all.md).
