---
title: Enable and Use DiskANN in Azure HorizonDB
description: This article describes how to enable DiskANN for improved semantic similarity search for Retrieval Augmented Generation (RAG) in Azure HorizonDB.
...
ms.custom:
  - build-2025
# customer intent: As a user, I want to learn how to enable and use DiskANN extension in Azure HorizonDB.
---

# Enable and use DiskANN extension in Azure HorizonDB
