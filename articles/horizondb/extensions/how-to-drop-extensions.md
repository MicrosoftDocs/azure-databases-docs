...
# Drop extensions for Azure HorizonDB (Preview)

Before dropping extensions in an Azure HorizonDB cluster, you must [allowlist](how-to-allow-extensions.md) them.
