...
description: This article describes how to drop extensions in an Azure HorizonDB flexible server instance.
...
ms.topic: how-to
# customer intent: As a user, I want to learn how to drop extensions in an Azure HorizonDB flexible server instance.
---
