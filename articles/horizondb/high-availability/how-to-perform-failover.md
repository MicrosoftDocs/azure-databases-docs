...
1. Note the replicas assigned to **Primary endpoint (read/write)** and **Reader endpoint**. Additionally, note the **Zone** values assigned to **ReadWrite** and **Read** Roles.
   ...
   :::image type="content" source="media/how-to-perform-failover/forced-failover-01.png" alt-text="Screenshot that shows the dialog displayed before the initiation of a forced failover." lightbox="media/how-to-perform-failover/forced-failover-001.png":::
