---
title: Release Notes for Azure HorizonDB Maintenance - March 2026
description: Learn about the maintenance release notes for Azure HorizonDB March 2026.
...
# Azure HorizonDB: March 2026 Release

We're excited to announce the March 2026 version of Azure HorizonDB. Starting March 3, 2026, the service automatically onboards all new servers to this latest version. The service upgrades existing servers during their next scheduled maintenance.

This new version introduces a range of new features and enhancements, resolves known issues, and includes essential security patches to ensure optimal performance and security.

## Engine version changes

- Latest minor versions updated for Azure HorizonDB: 18.2, 17.8, 16.12, 15.16, and 14.21.
