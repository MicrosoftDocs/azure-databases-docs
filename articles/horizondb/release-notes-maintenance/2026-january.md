---
title: Release Notes for Azure HorizonDB Maintenance - January 2026
description: Learn about the maintenance release notes for Azure HorizonDB January 2026.
...
# Azure HorizonDB: January 2026 Release

We're excited to announce the January 2026 version of Azure HorizonDB. Starting January 20, 2026, the service automatically onboards all new servers to this latest version. The service upgrades existing servers during their next scheduled maintenance.

This new version introduces a range of new features and enhancements, resolves known issues, and includes essential security patches to ensure optimal performance and security.

## Engine version changes

- PG18 is now generally available on Azure HorizonDB for new server deployments.
