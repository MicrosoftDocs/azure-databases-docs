...
That estimation can be seen throughout the server creation experience, in the **New Azure HorizonDB Flexible server** page:

:::image type="content" source="../../extensions/media/compute-storage-pricing/new-server-estimated-costs.png" alt-text="Screenshot that shows the estimated monthly costs in the New Azure HorizonDB Flexible server wizard." lightbox="../../extensions/media/compute-storage-pricing/new-server-estimated-costs.png":::
...
:::image type="content" source="../../extensions/media/compute-storage-pricing/existing-server-estimated-costs.png" alt-text="Screenshot that shows the Azure pricing calculator." lightbox="../../extensions/media/compute-storage-pricing/existing-server-estimated-costs.png":::
