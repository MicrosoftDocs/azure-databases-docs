...
1. **Choose the appropriate method**: Depending on your dump choose between two methods:
...
1. **Copy and paste commands**: The portal provides you dump-restore/dropdown-list-of-databases.png" alt-text="Screenshot showing the dropdown where specific database can be chosen." lightbox="media/how-to-migrate-dumpe these commands.
