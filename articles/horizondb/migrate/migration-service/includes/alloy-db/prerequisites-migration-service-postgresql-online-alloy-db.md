...
> [!NOTE]  
> The migration service in Azure HorizonDB supports connections using the IP address for source Google AlloyDB for PostgreSQL. The format `myproject:myregion:myinstance` isn't supported.
