---
title: "Prerequisites For The Migration Service In Azure HorizonDB (Online)"
...
Before you start your migration with migration service in Azure HorizonDB, fulfilling the following prerequisites, which apply to offline migration scenarios is essential.
...
- Azure HorizonDB must be set up in Azure before migration.
