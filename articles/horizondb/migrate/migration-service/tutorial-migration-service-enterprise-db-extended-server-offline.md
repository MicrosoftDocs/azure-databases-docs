...
This article guides you in migrating an EDB Extended server instance to Azure HorizonDB flexible server in offline mode.
...
- [Migrate online from EDB Extended server](tutorial-migration-service-enterprise-db-extended-server-online.md)
