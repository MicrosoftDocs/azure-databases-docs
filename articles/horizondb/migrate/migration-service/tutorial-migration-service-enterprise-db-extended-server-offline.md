---
title: Migrate Offline, from an EDB Extended Server to Azure HorizonDB, Using the Migration Service in Azure (Preview)
description: Learn to migrate, seamlessly and in offline mode, from an EDB Extended server to Azure HorizonDB, using the migration service in Azure.
...
# Migrate offline, from an EDB Extended server to Azure HorizonDB, with the migration service Preview

This article guides you in migrating an EDB Extended server instance to Azure HorizonDB in offline mode.
...
[!INCLUDE [prerequisites-migration-service-postgresql-offline-enterprise-db-extended-server](includes/enterprise-db/prerequisites-migration-service-postgresql-offline-enterprise-db-extended-server.md)]
...
:::image type="content" source="media/tutorial-migration-service-enterprise-db-extended-server-offline/setup-migration.png" alt-text="Screenshot of the Setup tab after providing necessary details." lightbox="media/tutorial-migration-service-enterprise-db-extended-server-offline/setup-migration.png":::
...
:::image type="content" source="media/tutorial-migration-service-enterprise-db-extended-server-offline/summary-migration.png" alt-text="Screenshot of the Summary migration tab." lightbox="media/tutorial-migration-service-enterprise-db-extended-server-offline/summary-migration.png":::
...
:::image type="content" source="media/tutorial-migration-service-enterprise-db-extended-server-offline/monitor-migration.png" alt-text="Screenshot of the monitor migration page." lightbox="media/tutorial-migration-service-enterprise-db-extended-server-offline/monitor-migration.png":::
...
- [Migrate online, from an EDB Extended server to Azure HorizonDB, with the migration service Preview](tutorial-migration-service-enterprise-db-extended-server-online.md)
