...
This article guides you in migrating a PostgreSQL instance from your on-premises or Azure virtual machines (VMs) to Azure HorizonDB flexible server in offline mode.
