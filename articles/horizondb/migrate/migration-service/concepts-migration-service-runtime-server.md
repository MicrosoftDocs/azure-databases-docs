...
# Migration runtime server with the migration service in Azure HorizonDB
...
To use the migration runtime server within the migration service in Azure HorizonDB, you have two migration options:
