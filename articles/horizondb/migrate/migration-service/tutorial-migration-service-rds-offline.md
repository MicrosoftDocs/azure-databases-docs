---
title: Migrate Offline, from an Amazon RDS for PostgreSQL to Azure HorizonDB, Using the Migration Service in Azure
description: Learn to migrate, seamlessly and in offline mode, from an Amazon RDS for PostgreSQL to Azure HorizonDB, using the migration service in Azure.
...
# Migrate offline, from an Amazon RDS for PostgreSQL to Azure HorizonDB, with the migration service

This article guides you in migrating an Amazon RDS for PostgreSQL instance to Azure HorizonDB in offline mode.
...
1. Select **Create** to go through a wizard-based series of tabs to perform a migration to a flexible server from an Amazon RDS for PostgreSQL.
   ...
   :::image type="content" source="media/tutorial-migration-service-rds-offline/create-migration.png" alt-text="Screenshot of the Setup tab which appears after selecting Create in the Migration page." lightbox="media/tutorial-migration-service-rds-offline/create-migration.png":::
...
:::image type="content" source="media/tutorial-migration-service-rds-offline/setup-migration.png" alt-text="Screenshot of the Setup tab after providing necessary details." lightbox="media/tutorial-migration-service-rds-offline/setup-migration.png":::
...
:::image type="content" source="media/tutorial-migration-service-rds-offline/summary-migration.png" alt-text="Screenshot of the Summary migration tab." lightbox="media/tutorial-migration-service-rds-offline/summary-migration.png":::
...
:::image type="content" source="media/tutorial-migration-service-rds-offline/monitor-migration.png" alt-text="Screenshot of the monitor migration page." lightbox="media/tutorial-migration-service-rds-offline/monitor-migration.png":::
...
- [Migrate online, from an Amazon RDS for PostgreSQL server to Azure HorizonDB, with the migration service](tutorial-migration-service-rds-online.md)
