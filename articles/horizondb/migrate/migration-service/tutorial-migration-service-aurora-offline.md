---
title: Migrate Offline, from an Amazon Aurora PostgreSQL to Azure HorizonDB, Using the Migration Service in Azure
description: Learn to migrate, seamlessly and in offline mode, from an Amazon Aurora PostgreSQL to Azure HorizonDB, using the migration service in Azure.
...
# Migrate offline, from an Amazon Aurora PostgreSQL to Azure HorizonDB, with the migration service

This article guides you in migrating an Amazon Aurora PostgreSQL instance to Azure HorizonDB in offline mode.
...
- [Migrate online, from an Amazon Aurora PostgreSQL server to Azure HorizonDB, with the migration service](tutorial-migration-service-aurora-online.md)
