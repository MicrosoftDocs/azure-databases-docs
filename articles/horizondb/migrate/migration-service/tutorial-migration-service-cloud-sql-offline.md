---
title: Migrate Offline, from a Google Cloud SQL for PostgreSQL to Azure HorizonDB, Using the Migration Service in Azure
description: Learn to migrate, seamlessly and in offline mode, from a Google Cloud SQL for PostgreSQL to Azure HorizonDB, using the migration service in Azure.
...
# Migrate offline, from a Google Cloud SQL for PostgreSQL to Azure HorizonDB, with the migration service

This article guides you in migrating a Google Cloud SQL for PostgreSQL instance to Azure HorizonDB in offline mode.
...
- [Migrate online, from a Google Cloud SQL for PostgreSQL server to Azure HorizonDB, with the migration service](tutorial-migration-service-cloud-sql-online.md)
