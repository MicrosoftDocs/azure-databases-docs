---
title: Known Issues and Limitations for the Migration Service in Azure HorizonDB
description: This article describes the limitations and known issues of the migration service in Azure HorizonDB.
...
# Known issues and limitations for the migration service in Azure HorizonDB

This article describes the known issues and limitations that are associated with the migration service in Azure HorizonDB.
...
- You can't move extensions that aren't supported by Azure HorizonDB. Supported extensions are listed in [Extensions for Azure HorizonDB](/azure/postgresql/flexible-server/concepts-extensions).
- User-defined collations can't be migrated to Azure HorizonDB.
- You can't migrate to an earlier version. For instance, you can't migrate from Azure HorizonDB version 15 to Azure HorizonDB version 14.
...
- Azure HorizonDB doesn't support the creation of custom tablespaces due to restrictions on superuser permissions. During migration, data from custom tablespaces in the source PostgreSQL instance is migrated to the default tablespaces of the target instance of Azure HorizonDB.
