...
This quickstart walks you through converting **Oracle client application code** to Azure HorizonDB by using the **Application Conversion** feature in the Oracle to Azure HorizonDB migration tooling, available in the Visual Studio Code PostgreSQL extension.
