---
title: "Oracle to Azure HorizonDB: Ora2Pg Migration Guide"
description: This guide helps you to migrate your Oracle schema to Azure HorizonDB using Ora2Pg.
...
# Migrate Oracle to Azure HorizonDB Using Ora2Pg

This guide helps you to migrate your Oracle schema to Azure HorizonDB.
...
To migrate your Oracle schema to Azure HorizonDB, you need to:
...
:::image type="content" source="media/how-to-migrate-oracle-ora2pg/ora2pg-migration-architecture.png" alt-text="Screenshot of the Ora2Pg migration architecture.":::

After you provision the VM and Azure HorizonDB, you need two configurations to enable connectivity between them: **Allow access to Azure services** and **Enforce SSL Connection**:
...
1. **Assess**: Assess those databases for potential migration issues or blockers.
1. **Convert**: Resolve any items you uncovered.

For heterogenous migrations such as Oracle to Azure HorizonDB, this stage also involves making the source database schemas compatible with the target environment.
...
Finally, compile all files against the Azure HorizonDB server. You can choose to load the manually generated DDL files or use the second script *import_all.sh* to import those files interactively.
...
For more information, see [Oracle to Azure HorizonDB migration workarounds](https://github.com/Microsoft/DataMigrationTeam/blob/master/Whitepapers/Oracle%20to%20Azure%20Database%20for%20PostgreSQL%20Migration%20Workarounds.pdf).
...
| --- | --- |
| [Oracle to Azure PostgreSQL migration cookbook](https://www.microsoft.com/download/details.aspx?id=103473) | This document helps architects, consultants, database administrators, and related roles quickly migrate workloads from Oracle to Azure HorizonDB by using Ora2Pg. |
...
- [Services and tools for data migration](../../dms/dms-tools-matrix.md)
