...
description: This sample Azure CLI script shows how to enable and download the server logs of an Azure HorizonDB flexible server instance.
...
# Enable and download server slow query logs of an Azure HorizonDB flexible server instance using Azure CLI

This sample CLI script enables and downloads the slow query logs of a single Azure HorizonDB flexible server instance.
...
- {[Azure CLI samples for Azure HorizonDB flexible server instance](../sample-scripts-azure-cli.md)}
