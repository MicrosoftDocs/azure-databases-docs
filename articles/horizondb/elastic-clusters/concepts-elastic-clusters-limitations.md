...
This section lists the key capacity and functional limitations specific to elastic clusters in Azure HorizonDB flexible server. Use this information to understand which features are unsupported or behave differently compared to standard flexible servers.
...
- [What is an elastic cluster in Azure HorizonDB?](../elastic-clusters/concepts-elastic-clusters.md)
