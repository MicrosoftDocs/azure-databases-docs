...
# Sharding models on elastic clusters in Azure HorizonDB
...
Elastic clusters on Azure HorizonDB offer two types of data sharding: row-based and schema-based. Each option comes with its own [tradeoffs](#sharding-tradeoffs), allowing you to choose the approach that best aligns with your application's requirements.
