---
title: Elastic Cluster Maximum Client Connections Default Behavior in Azure HorizonDB
description: This article describes how the maximum number of client connections are adjusted when scaling out nodes of an Azure HorizonDB elastic cluster.
...
# Maximum client connections across an elastic cluster in Azure HorizonDB
...
- [Quickstart: Create an instance of elastic cluster in Azure HorizonDB](quickstart-create-elastic-cluster-portal.md)
