...
description: This article describes how to perform on-demand backups of an Azure HorizonDB flexible server.
...
ms.topic: how-to
# customer intent: As a user, I want to learn how can I performn on-demand backups of an Azure HorizonDB.
---

# Perform on-demand backups

This article provides step-by-step instructions to perform on-demand backups of an Azure HorizonDB flexible server.
