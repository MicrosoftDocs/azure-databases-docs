---
title: Restore Full Backup (Fast Restore) in Azure HorizonDB
description: This article describes how to restore a full backup (fast restore) in Azure HorizonDB.
...
ms.topic: how-to
# customer intent: As a user, I want to learn how to restore a full backup (fast restore) in Azure HorizonDB.
---

# Restore full backup (fast restore) in Azure HorizonDB

This article provides step-by-step instructions to perform a restore in Azure HorizonDB to one of its available full backups.
