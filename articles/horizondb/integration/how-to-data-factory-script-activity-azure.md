...
- An Azure HorizonDB instance. To learn more, see [Create an Azure HorizonDB](/azure/postgresql/flexible-server/quickstart-create-cluster).
...
1. Switch to the **Settings** tab and select your Azure HorizonDB linked service, or create a new one. Once added, select **Test connection** to verify your connection is valid.
