...
description: Instructions and information on how to configure and connect using SCRAM in an Azure HorizonDB flexible server instance.
...
> [!NOTE]  
> To access an Azure HorizonDB flexible server instance using SCRAM method of authentication, your client libraries need to support SCRAM. Refer to the **[list of drivers](https://wiki.postgresql.org/wiki/List_of_drivers)** that support SCRAM.
...
2. Navigate to your Azure HorizonDB flexible server instance
...
1. From your Azure HorizonDB flexible server client, connect to the Azure HorizonDB flexible server instance. For example,
