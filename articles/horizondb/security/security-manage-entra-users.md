...
Azure HorizonDB internally stores the mapping between PostgreSQL database roles and unique identifiers of Microsoft Entra objects.
...
Azure HorizonDB uses security labels associated with database roles to store their corresponding Microsoft Entra ID mapping.
