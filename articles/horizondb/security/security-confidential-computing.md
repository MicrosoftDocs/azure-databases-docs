...
The SKUs that support Azure Confidential Computing (ACC) for Azure HorizonDB are:
...
You can deploy Azure HorizonDB with ACC by using various methods, such as the Azure portal, Azure CLI, ARM templates, Bicep, Terraform, Azure PowerShell, REST API, and more.

For this example, use the Azure portal.

Follow the steps below to deploy an [Azure HorizonDB](https://ms.portal.azure.com/#create/Microsoft.PostgreSQLFlexibleServer) server:
...
| Feature | Confidential Compute VMs | ACC for Azure HorizonDB |
| --- | --- | --- |
...
- Only AMD SEV-SNP processors are supported. Intel TDX processors aren't currently compatible with Azure HorizonDB.
