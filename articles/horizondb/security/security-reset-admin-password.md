...
description: This article describes how to reset the password of the administrator of an Azure HorizonDB flexible server instance.
...
This article provides step-by-step instructions to reset the administrator password of an Azure HorizonDB flexible server instance.
...
2. In the resource menu, select **Overview**.
    ...
    :::image type="content" source="./media/security-reset-admin-password/overview.png" alt-text="Screenshot showing the Overview page of an Azure HorizonDB flexible server instance." lightbox="./media/security-reset-admin-password/overview.png":::
...
4. In the resource menu, under the **Security** section, select **Authentication**.
    ...
    :::image type="content" source="./media/security-reset-admin-password/authentication.png" alt-text="Screenshot showing the Authentication page of an Azure HorizonDB flexible server instance." lightbox="./media/security-reset-admin-password/authentication.png":::
