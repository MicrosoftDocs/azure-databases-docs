...
description: Learn about the concepts of Microsoft Entra ID for authentication with Azure HorizonDB.
...
# Microsoft Entra authentication with Azure HorizonDB
...
- Support of token-based authentication for applications that connect to Azure HorizonDB flexible server instance.
...
For the steps to configure Microsoft Entra ID with Azure HorizonDB, see [Use Microsoft Entra ID for authentication with Azure HorizonDB](security-entra-configure.md).
...
The Microsoft Entra administrator can be a Microsoft Entra user, Microsoft Entra group, service principal, or managed identity. Using a group account as an administrator enhances manageability. It permits the centralized addition and removal of group members in Microsoft Entra ID without changing the users or permissions within the Azure HorizonDB flexible server instance.

You can configure multiple Microsoft Entra administrators concurrently. You can deactivate password authentication to an Azure HorizonDB flexible server instance for enhanced auditing and compliance requirements.
...
- You can configure multiple Microsoft Entra principals (user, group, service principal, or managed identity) as Microsoft Entra administrators for an Azure HorizonDB flexible server instance at any time.

- Only a Microsoft Entra administrator for PostgreSQL can initially connect to the Azure HorizonDB flexible server instance by using a Microsoft Entra account. The Active Directory administrator can configure subsequent Microsoft Entra database users.
...
- **What happens when I enable Microsoft Entra authentication on my Azure HorizonDB flexible server instance?**
...
## Related content
- [Use Microsoft Entra ID in Azure HorizonDB](../security/security-entra-configure.md)
