...
description: Certificate rotation for Azure HorizonDB
...
> [!IMPORTANT]  
> **Microsoft is rotating TLS certificates for Azure HorizonDB** to update the Certificate Authority and the resulting certificate chain.
>
