...
1. An Azure HorizonDB instance. If you don't have one, [create an Azure HorizonDB instance](/azure/postgresql/flexible-server/quickstart-create-cluster-portal).
