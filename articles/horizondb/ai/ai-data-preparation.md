...
- **In a pipeline**: Use the `ai.embed()` step in an [Implement durable AI pipelines in Azure HorizonDB (Preview)](ai-pipelines.md) to embed text at scale with built-in retries, checkpointing, and crash recovery.
