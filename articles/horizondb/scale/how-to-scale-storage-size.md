...
description: This article describes how to scale the storage size of an Azure HorizonDB flexible server.
...
ms.topic: how-to
#customer intent: As a user, I want to learn how to scale the storage size of an Azure HorizonDB.
---

# Scale storage size

This article provides step-by-step instructions to increase the size allocated to the storage of an Azure HorizonDB flexible server.
...
Whether you use the manual or automatic approach, you're only allowed to increase the size of the storage assigned to your Azure HorizonDB flexible server. Decreasing the size of the storage isn't supported.
