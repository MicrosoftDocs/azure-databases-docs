---
title: Troubleshooting Guides Overview in Azure HorizonDB
description: Troubleshooting guides overview in Azure HorizonDB.
...
# Troubleshooting guides overview in Azure HorizonDB

The troubleshooting guides for Azure HorizonDB are designed to help you quickly identify and resolve common challenges you might encounter while using Azure HorizonDB. Integrated directly into the Azure portal, the troubleshooting guides provide actionable insights, recommendations, and data visualizations to assist you in diagnosing and addressing issues related to common performance problems. With these guides at your disposal, you're better equipped to optimize your Azure HorizonDB experience and ensure a smoother, more efficient database operation.
...
Each guide is packed with multiple charts, guidelines, recommendations tailored to the specific problem you might encounter, which can help expedite the troubleshooting process.
The troubleshooting guides are directly integrated into the Azure portal and your Azure HorizonDB instance, making them convenient and easy to use.
...
Before using any troubleshooting guide, it's essential to ensure that all prerequisites are in place. For a detailed list of prerequisites refer to the article [Use the troubleshooting guides in Azure HorizonDB](how-to-troubleshooting-guides.md).
