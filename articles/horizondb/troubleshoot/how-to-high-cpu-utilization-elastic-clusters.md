...
# Troubleshoot high CPU utilization in Azure HorizonDB Elastic Clusters

This article describes how to identify the root cause of high CPU utilization. It also provides possible remedial actions to control CPU utilization when using [Elastic clusters in Azure HorizonDB](../elastic-clusters/concepts-elastic-clusters.md).
