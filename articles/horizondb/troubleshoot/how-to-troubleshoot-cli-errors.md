...
description: This topic gives guidance on troubleshooting common issues with Azure CLI when using Azure HorizonDB flexible server.
...
# Troubleshoot Azure HorizonDB  CLI errors

This article helps you troubleshoot common issues with Azure CLI when using Azure HorizonDB flexible server.
...
1. List the deployments in resource group to identify the Azure HorizonDB flexible server deployment.
...
2. Get the request content of the Azure HorizonDB flexible server deployment. 
    ```azurecli-interactive
        az deployment operation group list \
          --name exampledeployment \
          -g examplegroup \
...
|LocationNotAvailableForResourceType| - Check availability of Azure HorizonDB flexible server in [Azure regions](https://azure.microsoft.com/global-infrastructure/services/?products=postgresql). <br>- Check if Azure HorizonDB flexible server Resource types is registered with your subscription.                                                      |
...
|InvalidLocation| An invalid location was specified. Check availability of Azure HorizonDB flexible server in [Azure regions](https://azure.microsoft.com/global-infrastructure/services/?products=postgresql).                                                                                                                                       |
|InvalidServerName| Identified an invalid server name. Check the server name. Run the command [az postgres flexible-server list](/cli/azure/postgres/flexible-server#az-postgres-server-list) to see all the list of Azure HorizonDB available.                                                                         |
