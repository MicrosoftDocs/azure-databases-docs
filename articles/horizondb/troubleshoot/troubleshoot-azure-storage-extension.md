---
title: Troubleshoot the Azure Storage Extension in Azure HorizonDB
description: Learn how to troubleshoot the Azure Storage extension in Azure HorizonDB to import and export data.
...
# Troubleshoot the Azure Storage extension in Azure HorizonDB
...
### ERROR: azure_storage: Permission isn't sufficient to perform requested operation
...
### ERROR: azure_storage: Query isn't supported while copying data to blob storage
...
### ERROR: azure_storage: couldn't infer file encoding from extension: '<extension>', use a supported extension [csv, csv.gz, tsv, tsv.gz, json, json.gz, xml, xml.gz, txt, txt.gz, parquet], or specify the decoder argument if you're using blob_get or format if using COPY FROM/TO
...
### ERROR: azure_storage: container with the given name doesn't exist
...
### ERROR: azure_storage: blob with the given name doesn't exist
...
- [Reference of functions provided by the Azure Storage extension in Azure HorizonDB](../extensions/reference-azure-storage-extension.md)
- [Azure storage extension in Azure HorizonDB](../extensions/concepts-storage-extension.md)
- [Configure the Azure Storage extension in Azure HorizonDB](../extensions/how-to-configure-azure-storage-extension.md)
- [Quickstart examples for Azure Storage extension in Azure HorizonDB](../extensions/quickstart-azure-storage-extension.md)
