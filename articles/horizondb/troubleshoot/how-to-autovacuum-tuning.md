...
Azure HorizonDB provides the following metrics for monitoring autovacuum.
...
For guidance, see [special considerations about using pg_cron in Azure HorizonDB](../extensions/concepts-extensions-considerations.md#pg_cron).
...
- [Full vacuum using pg_repack in Azure HorizonDB](how-to-perform-fullvacuum-pg-repack.md)
