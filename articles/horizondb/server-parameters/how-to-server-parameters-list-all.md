...
description: This article describes how to list all server parameters of an Azure HorizonDB flexible server.
...
ms.topic: how-to
#customer intent: As a user, I want to learn how to list all server parameters of an Azure HorizonDB.
---

# List all server parameters

This article provides step-by-step instructions to list all server parameters of an Azure HorizonDB flexible server.
