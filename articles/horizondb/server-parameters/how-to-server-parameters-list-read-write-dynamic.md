...
description: This article describes how to list read-write dynamic server parameters of an Azure HorizonDB flexible server.
...
ms.topic: how-to
#customer intent: As a user, I want to learn how to list read-write dynamic server parameters of an Azure HorizonDB.
---

# List read-write dynamic server parameters

This article provides step-by-step instructions to list read-write dynamic server parameters of an Azure HorizonDB flexible server.
