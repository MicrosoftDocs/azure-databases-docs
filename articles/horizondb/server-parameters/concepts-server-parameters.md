...
description: Learn about the server parameters for an Azure HorizonDB flexible server instance.
...
# Server parameters in Azure HorizonDB 

Azure HorizonDB provides a set of configurable parameters for each server.
