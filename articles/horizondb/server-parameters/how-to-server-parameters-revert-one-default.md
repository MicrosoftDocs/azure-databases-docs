...
description: This article describes how to revert one server parameter to its default of an Azure HorizonDB flexible server.
...
ms.topic: how-to
#customer intent: As a user, I want to learn how to revert one server parameter to its default of an Azure HorizonDB.
---

# Revert one server parameter to its default

This article provides step-by-step instructions to revert one server parameter to its default of an Azure HorizonDB flexible server.
