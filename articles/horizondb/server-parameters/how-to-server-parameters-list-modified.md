...
description: This article describes how to list all server parameters with modified defaults of an Azure HorizonDB flexible server.
...
ms.topic: how-to
#customer intent: As a user, I want to learn how to list all server parameters with modified defaults of an Azure HorizonDB.
---

# List server parameters with modified defaults

This article provides step-by-step instructions to list all server parameters with modified defaults of an Azure HorizonDB flexible server.
