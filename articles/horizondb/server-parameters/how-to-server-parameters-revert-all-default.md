...
description: This article describes how to revert all server parameters to their defaults of an Azure HorizonDB flexible server.
...
ms.topic: how-to
#customer intent: As a user, I want to learn how to revert all server parameters to their defaults of an Azure HorizonDB.
---

# Revert all server parameters to their defaults

This article provides step-by-step instructions to revert all server parameters to their defaults of an Azure HorizonDB flexible server.
