...
| --- | --- |
| Category | Customized Options |
| Description | Specifies if hostname is allowed in the username for Azure HorizonDB Flexible Server. |
| Data type | boolean |
| Default value | `off` |
| Allowed values | `off` |
...
| --- | --- |
| Category | Customized Options |
| Description | Specifies if this is a server created for migrating from Azure HorizonDB Single Server to Flexible Server. |
| Data type | boolean |
| Default value | `off` |
| Allowed values | `off` |
| Parameter type | read-only |
