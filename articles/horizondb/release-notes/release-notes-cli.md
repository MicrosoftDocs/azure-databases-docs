---
title: CLI Release Notes in Azure HorizonDB
description: Azure CLI release notes in Azure HorizonDB.
...
# Azure CLI release notes in Azure HorizonDB

This page provides latest news and updates regarding the Azure HorizonDB additions for Azure CLI.
