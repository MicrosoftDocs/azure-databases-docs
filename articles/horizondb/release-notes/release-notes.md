...
# Release notes - Azure HorizonDB

This article highlights the latest updates and enhancements for Azure HorizonDB, service including new feature releases, supported engine versions, available extensions, and other important announcements.

## Release: March 2026

- Preview
  - [Data encryption at rest in Azure HorizonDB](../security/security-data-encryption.md)
...
- Preview
  - [Geo-replication in Azure HorizonDB](../read-replica/concepts-read-replicas-geo.md)
  - [Geo-disaster recovery in Azure HorizonDB](../backup-restore/concepts-geo-disaster-recovery.md)
  - [Major version upgrades in Azure HorizonDB](../configure-maintain/concepts-major-version-upgrade.md)
...
- General availability
  ...
  - Support for [.NET](https://www.nuget.org/packages/Azure.ResourceManager.PostgreSql/#versions-body-tab) SDK with [API release notes in Azure HorizonDB](release-notes-api.md) version.
...
- General availability
  - [Supported versions of PostgreSQL in Azure HorizonDB](../configure-maintain/concepts-supported-versions.md) for Azure HorizonDB.
  - [Azure HorizonDB mirroring in Microsoft Fabric](../integration/concepts-fabric-mirroring.md)
  - [Elastic clusters in Azure HorizonDB](../elastic-clusters/concepts-elastic-clusters.md)

## Release: October 2025

- General availability
  - Support for new [PgBouncer in Azure HorizonDB](../connectivity/concepts-pgbouncer.md) 1.23.1. <sup>$</sup>
  ...
  - [Azure HorizonDB - Maintenance release notes index](../release-notes-maintenance/release-notes-maintenance-index.md) of upcoming maintenance upgrades now available.
- Preview
  - [Read replicas in Azure HorizonDB](../read-replica/concepts-read-replicas.md)
...
- Support for [Ansible collection](https://galaxy.ansible.com/ui/repo/published/azure/azcollection/content/?version=3.6.0) with [API release notes in Azure HorizonDB](release-notes-api.md) version.
...
- General Availability
  ...
  - [Enable and use DiskANN extension in Azure HorizonDB](../extensions/how-to-use-pgdiskann.md)
  ...
  - [Resiliency solution accelerator](https://github.com/Azure-Samples/Azure-PostgreSQL-Resilience-Architecture) for Azure HorizonDB
- Preview
  - [Azure Confidential Computing in Azure HorizonDB](../security/security-confidential-computing.md)
  - [AGE extension in Azure HorizonDB](../azure-ai/generative-ai-age-overview.md)
  - [Semantic operators in the Azure AI extension (Preview)](../azure-ai/generative-ai-azure-ai-semantic-operators.md)
  - {[What is the PostgreSQL extension for Visual Studio Code with HorizonDB](../development/vs-code-extension/vs-code-overview.md)}
  - {[Quickstart: Configure GitHub Copilot for PostgreSQL extension in Visual Studio Code](../development/vs-code-extension/vs-code-github-copilot.md)}
  - [Major version upgrades in Azure HorizonDB](../configure-maintain/concepts-major-version-upgrade.md)

## Release: April 2025

- Public preview of [Fabric Mirroring](https://techcommunity.microsoft.com/blog/adforpostgresql/announcing-mirroring-for-azure-database-for-postgresql-in-microsoft-fabric-for-p/4396750) for Azure HorizonDB.
- Public preview of [Automatic key version updates](../security/security-data-encryption.md#cmk-key-version-updates).
- Public preview of [Model Context Protocol (MCP) Server](https://techcommunity.microsoft.com/blog/adforpostgresql/introducing-model-context-protocol-mcp-server-for-azure-database-for-postgresql-/4404360) for Azure HorizonDB.
- General availability of [New Zealand North](../overview.md#azure-regions) region.
- Support for [Terraform](https://registry.terraform.io/providers/hashicorp/azurerm/4.24.0/docs/resources/postgresql_server) resource with [API release notes in Azure HorizonDB](release-notes-api.md) version.
...
- Support for [pg_signal_autovacuum_worker](../troubleshoot/how-to-autovacuum-tuning.md#troubleshooting-guides) role in PostgreSQL versions 15 and higher for Azure HorizonDB.
...
- Public preview of [Enable and use DiskANN extension in Azure HorizonDB](../extensions/how-to-use-pgdiskann.md) is now available.

## Release: January 2025

- Public preview of [Elastic clusters in Azure HorizonDB](../elastic-clusters/concepts-elastic-clusters.md) for Azure HorizonDB.

## Release: December 2024

- General Availability of [oracle_fdw](../extensions/concepts-extensions-versions.md#oracle_fdw) extension.
- General Availability of [index tuning](../monitor/concepts-autonomous-tuning.md) on Azure HorizonDB.
- General Availability of the [Semantic Ranker Solution Accelerator](https://aka.ms/pg-ranker) for Azure HorizonDB.
- Public preview of [age](../extensions/concepts-extensions-versions.md#age) extension.
- Public preview of [GraphRAG Solution Accelerator](https://aka.ms/pg-graphrag) for Azure HorizonDB.

## Release: November 2024

- General availability of [High Availability (HA) health status monitoring in Azure HorizonDB](../high-availability/how-to-monitor-high-availability.md) for Azure HorizonDB.
- [Version policy in Azure HorizonDB](../configure-maintain/concepts-version-policy.md) retires on November 14, 2024. Upgrade to a supported version before retirement to ensure continued support and security.

## Release: October 2024

- General Availability of [Quickstart: Manage Azure HorizonDB using automation tasks](../integration/create-automation-tasks.md).
- Preview of [Fabric Mirroring](https://techcommunity.microsoft.com/blog/adforpostgresql/mirroring-azure-database-for-postgresql-flexible-server-in-microsoft-fabric---pr/4251876) for Azure HorizonDB.

## Release: September 2024

- Public preview of [Supported versions of PostgreSQL in Azure HorizonDB](../configure-maintain/concepts-supported-versions.md) for Azure HorizonDB.
...
- Support for [Prepay for compute resources with reserved capacity in Azure HorizonDB](../configure-maintain/concepts-reserved-pricing.md) for Intel and AMD V5 Skus for Azure HorizonDB.
...
- General availability of [Monitor metrics in Azure HorizonDB](../monitor/concepts-monitoring.md) for Azure HorizonDB.
- General availability: [postgres_protobuf](../extensions/concepts-extensions-versions.md#postgres_protobuf) extension.

## Release: July 2024

- General availability of [Major version upgrades in Azure HorizonDB](../configure-maintain/concepts-major-version-upgrade.md) for Azure HorizonDB.
- General availability of [Pgvector 0.7.0](../extensions/concepts-extensions-versions.md#vector) extension.
- General availability support for [Read replicas in Azure HorizonDB](../read-replica/concepts-read-replicas.md)
- Support for [SCRAM authentication in Azure HorizonDB](../security/security-connect-scram.md) authentication set as default for new PostgreSQL 14+ new server deployments.
- General availability support for [Firewall rules in Azure HorizonDB](../security/security-firewall-rules.md) for Azure HorizonDB.
...
- General availability of {[IOPS scaling](../compute-storage/concepts-storage-premium-ssd.md#iops-scaling)} on Azure HorizonDB.
...
- Public preview of [index tuning](../monitor/concepts-autonomous-tuning.md) on Azure HorizonDB.
- Public preview of [Update extensions in Azure HorizonDB](../extensions/how-to-update-extensions.md) on Azure HorizonDB.
...
- Support for new [PgBouncer in Azure HorizonDB](../connectivity/concepts-pgbouncer.md) 1.22.1. <sup>$</sup>

## Release: March 2024

- Public preview of [Major version upgrades in Azure HorizonDB](../configure-maintain/concepts-major-version-upgrade.md) for Azure HorizonDB.
- Public preview of [real-time language translations](../azure-ai/generative-ai-azure-cognitive.md#language-translation) with azure_ai extension on Azure HorizonDB.
- Public preview of [real-time machine learning predictions](../azure-ai/generative-ai-azure-machine-learning.md) with azure_ai extension on Azure HorizonDB.
- General availability of version 0.6.0 of [vector](../extensions/how-to-use-pgvector.md) extension on Azure HorizonDB.
- General availability of {[What is the migration service in Azure Database for PostgreSQL?](../../postgresql/migrate/migration-service/overview-migration-service-postgresql.md)} in Azure HorizonDB.
- Support for PostgreSQL 16 changes with [Secure your Azure HorizonDB](../security/security-overview.md)
...
- General availability of [Download PostgreSQL and upgrade logs in Azure HorizonDB](../monitor/how-to-configure-server-logs.md), including Portal and CLI support.
...
- Public preview of [Download PostgreSQL and upgrade logs in Azure HorizonDB](../monitor/how-to-configure-server-logs.md).
- General availability of [Transport Layer Security (TLS) in Azure HorizonDB](../security/security-tls.md)
- General availability of [Secure your Azure HorizonDB](../security/security-overview.md)

## Release: November 2023

- General availability of PostgreSQL 16 for Azure HorizonDB.
...
- Public preview of {[premium SSD v2](../compute-storage/concepts-storage.md)}.
- Public preview of {[decoupling storage and IOPS](../compute-storage/concepts-storage.md)}.
...
- General availability of [Grafana Monitoring Dashboard](https://grafana.com/grafana/dashboards/21177-azure-azure-postgresql-flexible-server-monitoring/) for Azure HorizonDB.

## Release: September 2023

- General availability of {[Storage in Azure HorizonDB](../compute-storage/concepts-storage.md)} for Azure HorizonDB.
- General availability of [Restore to latest restore point in Azure HorizonDB](../backup-restore/how-to-restore-latest-restore-point.md) for Azure HorizonDB.

## Release: August 2023

- Support for latest [minor versions](../configure-maintain/concepts-supported-versions.md) 15.3, 14.8, 13.11, 12.15, 11.20. <sup>$</sup>
- General availability of [Enhanced Metrics](../monitor/concepts-monitoring.md#enhanced-metrics), [Autovacuum Metrics](../monitor/concepts-monitoring.md#autovacuum-metrics), [PgBouncer Metrics](../monitor/concepts-monitoring.md#pgbouncer-metrics) and [Database availability metric](../monitor/concepts-monitoring.md#database-availability-metric) for Azure HorizonDB.

## Release: July 2023

- General Availability of PostgreSQL 15 for Azure HorizonDB.
- Public preview of [Quickstart: Manage Azure HorizonDB using automation tasks](../integration/create-automation-tasks.md) for Azure HorizonDB.
...
- General availability of [Query Performance Insight in Azure HorizonDB](../monitor/concepts-query-performance-insight.md) for Azure HorizonDB.
- General availability of [Major version upgrades in Azure HorizonDB](../configure-maintain/concepts-major-version-upgrade.md) for Azure HorizonDB.
- General availability of [Restore a dropped cluster in Azure HorizonDB](../backup-restore/how-to-restore-dropped-server.md) for Azure HorizonDB.
- Public preview of {[Storage in Azure HorizonDB](../compute-storage/concepts-storage.md)} for Azure HorizonDBr.

## Release: May 2023

- Public preview of [Database availability metric](../monitor/concepts-monitoring.md#database-availability-metric) for Azure HorizonDB.
- PostgreSQL 15 is now available in public preview for Azure HorizonDB in limited regions (West Europe, East US, West US2, South East Asia, UK South, North Europe, Japan East).
- General availability: [Enable and use pgvector in Azure HorizonDB](../extensions/how-to-use-pgvector.md) for Azure HorizonDB.
- General availability: [Data encryption at rest in Azure HorizonDB](../security/security-data-encryption.md) with Azure HorizonDB.
- General availability {[Storage in Azure HorizonDB](../compute-storage/concepts-storage.md)} with Azure HorizonDB.
- Support for [Compute options in Azure HorizonDB](../compute-storage/concepts-compute.md) with Azure HorizonDB.

## Release: April 2023

- Public preview of [Query Performance Insight in Azure HorizonDB](../monitor/concepts-query-performance-insight.md) for Azure HorizonDB.
- Public preview of: [Quickstart: Import data in Power BI in Azure HorizonDB](../integration/connect-with-power-bi-desktop.md) for Azure HorizonDB.
- Public preview of [Troubleshooting guides overview in Azure HorizonDB](../troubleshoot/concepts-troubleshooting-guides.md) for Azure HorizonDB.

## Release: March 2023

- General availability of [Read replicas in Azure HorizonDB](../read-replica/concepts-read-replicas.md) for Azure HorizonDB.
- Public preview of [PgBouncer Metrics](../monitor/concepts-monitoring.md#pgbouncer-metrics) for Azure HorizonDB.
- General availability of [Monitor by using Azure Monitor workbooks in Azure HorizonDB](../monitor/concepts-workbooks.md) for Azure HorizonDB.

## Release: February 2023

- Public preview of [Autovacuum Metrics](../monitor/concepts-monitoring.md#autovacuum-metrics) for Azure HorizonDB.
- Support for [semver](../extensions/concepts-extensions-versions.md#semver) extension with new servers. <sup>$</sup>
- Public Preview of [Major version upgrades in Azure HorizonDB](../configure-maintain/concepts-major-version-upgrade.md) for Azure HorizonDB.
- Support for [Geo-redundant backup feature](../backup-restore/concepts-backup-restore.md#geo-redundant-backup-and-restore) when using [Data encryption at rest in Azure HorizonDB](../security/security-data-encryption.md).
- Support for latest [minor versions](../configure-maintain/concepts-supported-versions.md) 14.6, 13.9, 12.13, 11.18. <sup>$</sup>

## Release: January 2023

- General availability of [Microsoft Entra authentication in Azure HorizonDB](../security/security-entra-concepts.md) for Azure HorizonDB in all Azure Public Regions.
- General availability of [Data encryption at rest in Azure HorizonDB](../security/security-data-encryption.md) with Azure HorizonDB in all Azure public regions.

## Release: December 2022

- Support for [pg_hint_plan](../extensions/concepts-extensions-versions.md#pg_hint_plan) extension with new servers. <sup>$</sup>
- General availability of [Data encryption at rest in Azure HorizonDB](../security/security-data-encryption.md) with Azure HorizonDB in Canada East, Canada Central, Southeast Asia, Switzerland North, Switzerland West, Brazil South, and East Asia Azure regions.

## Release: November 2022

- Public preview of [Enhanced Metrics](../monitor/concepts-monitoring.md#enhanced-metrics) for Azure HorizonDB.
- Support for latest [minor versions](../configure-maintain/concepts-supported-versions.md) 14.5, 13.8, 12.12, 11.17. <sup>$</sup>
- General availability of Azure HorizonDB in China North 3 & China East 3 Regions.

## Release: October 2022

- Support for [Read replicas in Azure HorizonDB](../read-replica/concepts-read-replicas.md) feature in public preview.
- Support for [Microsoft Entra authentication in Azure HorizonDB](../security/security-entra-concepts.md) authentication in public preview.
- Support for [Data encryption at rest in Azure HorizonDB](../security/security-data-encryption.md) in public preview.
- Published [Security and compliance certifications in Azure HorizonDB](../security/security-compliance.md) for Azure HorizonDB.
- Postgres 14 is now the default PostgreSQL version.

## Release: September 2022

- Support for [Backup and restore in Azure HorizonDB](../backup-restore/concepts-backup-restore.md) feature.
- General availability of [Backup and restore in Azure HorizonDB](../backup-restore/concepts-backup-restore.md). See the [regions](../overview.md#azure-regions) where Geo-redundant backup is currently available.

## Release: August 2022

- Support for latest [Supported versions of PostgreSQL in Azure HorizonDB](../configure-maintain/concepts-supported-versions.md) 14.4. <sup>$</sup>
...
- Support for [Supported versions of PostgreSQL in Azure HorizonDB](../configure-maintain/concepts-supported-versions.md).
...
- General availability of Azure HorizonDB in Canada East and India West regions.
...
- Support for updating Private DNS Zone for [Network with private access (virtual network integration) in Azure HorizonDB](../network/concepts-networking-private.md) for existing servers<sup>$</sup>.
...
- Extensions need to be [allowlisted](../extensions/how-to-allow-extensions.md#allow-extensions-in-azure-horizondb) before they can be installed.
...
- Azure HorizonDB is [**Generally Available**](https://techcommunity.microsoft.com/blog/adforpostgresql/azure-database-for-postgresql-%E2%80%93-flexible-server-is-now-ga/2987030).
...
- Support for [Backup and restore in Azure HorizonDB](../backup-restore/concepts-backup-restore.md) feature in preview in selected paired regions - East US 2, Central US, North Europe, West Europe, Japan East, and Japan West.
...
- Support for [Azure Resource Health](/azure/service-health/resource-health-overview) for Azure HorizonDB health diagnosis and to get support.
- Several bug fixes, stability, and performance improvements.
...
- Support for [SCRAM authentication in Azure HorizonDB](../security/security-connect-scram.md) for all major versions with new server creates. <sup>$</sup>
...
- [Query store in Azure HorizonDB](../monitor/concepts-query-store.md) .
- Several bug fixes, stability, and performance improvements.

## Release: October 2020 - March 2021

- Improved experience connecting [connect](../connectivity/connect-azure-cli.md) to the Azure HorizonDB instance using Azure CLI with the `az postgres flexible- server connect` command.
