...
## Release: March 2026
- Preview
   - [Customer Managed Key support for Premium SSDv2 in Azure HorizonDB](../security/security-data-encryption.md)
...
- Preview
    - [Geo-replication support for Premium SSDv2 in Azure HorizonDB](../read-replica/concepts-read-replicas-geo.md)
    - [Geo-redundant backup support for Premium SSDv2 in Azure HorizonDB](../backup-restore/concepts-geo-disaster-recovery.md)
    - [Major Version Upgrade support for Premium SSDv2 in Azure HorizonDB](../configure-maintain/concepts-major-version-upgrade.md)
...
- General availability
    - [PostgreSQL 18](../configure-maintain/concepts-supported-versions.md) for Azure HorizonDB flexible server.
    - [Mirroring Azure HorizonDB in Microsoft Fabric](../integration/concepts-fabric-mirroring.md)
    - [Azure HorizonDB Elastic Clusters](../elastic-clusters/concepts-elastic-clusters.md)
...
- Preview
    - [Read Replica support for Premium SSDv2 in Azure HorizonDB](../read-replica/concepts-read-replicas.md)
...
- Preview
    ...
    - [Cascading read replica support in Azure HorizonDB](../read-replica/concepts-read-replicas.md)
...
- Public preview of [Elastic Clusters](../elastic-clusters/concepts-elastic-clusters.md) for Azure HorizonDB.
...
- General availability of [High-Availability Health Status Monitoring](../high-availability/how-to-monitor-high-availability.md) for Azure HorizonDB.
...
- Preview of [Fabric Mirroring](https://techcommunity.microsoft.com/t5/azure-database-for-postgresql/mirroring-azure-database-for-postgresql-flexible-server-in/ba-p/4251876) for Azure HorizonDB.

## Release: September 2024

- Public preview of [PostgreSQL 17](../configure-maintain/concepts-supported-versions.md) for Azure HorizonDB.
...
- Support for [Reserved pricing](../configure-maintain/concepts-reserved-pricing.md) for Intel and AMD V5 Skus for Azure HorizonDB.
...
- General availability of [Database Size Metrics](../monitor/concepts-monitoring.md) for Azure HorizonDB.
- General availability: [postgres_protobuf](../extensions/concepts-extensions-versions.md#postgres_protobuf) extension.

## Release: July 2024

- General availability of [Major Version Upgrade Support for PostgreSQL 16](../configure-maintain/concepts-major-version-upgrade.md) for Azure HorizonDB.
...
- General availability support for [System Assigned Managed Identity](../security/security-firewall-rules.md) for Azure HorizonDB.
...
- General availability of {[IOPS scaling](../configure-maintain/concepts-storage-premium-ssd.md#iops-scaling)} on Azure HorizonDB.
...
- Public preview of [Updating PostgreSQL extensions](../extensions/how-to-update-extensions.md) on Azure HorizonDB.
...
- Public preview of [Major Version Upgrade Support for PostgreSQL 16](../configure-maintain/concepts-major-version-upgrade.md) for Azure HorizonDB.
...
- General availability of {[Migration service](../../postgresql/migrate/migration-service/concepts-migration-service-postgresql.md)} in Azure HorizonDB.
...
- General availability of {[Storage autogrow](../extensions/concepts-storage.md)} for Azure HorizonDB.
- General availability of [Cross Subscription and Cross Resource Group Restore](../backup-restore/how-to-restore-latest-restore-point.md) for Azure HorizonDB.
...
- Public preview of [Automation Tasks](../integration/create-automation-tasks.md) for Azure HorizonDB.
...
- General availability of [Query Performance Insight](../monitor/concepts-query-performance-insight.md) for Azure HorizonDB.
- General availability of [Major Version Upgrade](../configure-maintain/concepts-major-version-upgrade.md) for Azure HorizonDB.
- General availability of [Restore a dropped server](../backup-restore/how-to-restore-dropped-server.md) for Azure HorizonDB.
- Public preview of {[Storage autogrow](../extensions/concepts-storage.md)} for Azure HorizonDBr.
...
- General availability: [Pgvector extension](../extensions/how-to-use-pgvector.md) for Azure HorizonDB.
- General availability: [Azure Key Vault Managed HSM](../security/security-data-encryption.md) with Azure HorizonDB.
- General availability {[32 TB Storage](../extensions/concepts-storage.md)} with Azure HorizonDB.
- Support for [Ddsv5 and Edsv5 SKUs](../compute-storage/concepts-compute.md) with Azure HorizonDB.

## Release: April 2023

- Public preview of [Query Performance Insight](../monitor/concepts-query-performance-insight.md) for Azure HorizonDB.
- Public preview of: [Power BI integration](../integration/connect-with-power-bi-desktop.md) for Azure HorizonDB.
- Public preview of [Troubleshooting guides](../troubleshoot/concepts-troubleshooting-guides.md) for Azure HorizonDB.

## Release: March 2023

- General availability of [Read Replica](../read-replica/concepts-read-replicas.md) for Azure HorizonDB.
- Public preview of [PgBouncer Metrics](../monitor/concepts-monitoring.md#pgbouncer-metrics) for Azure HorizonDB.
- General availability of [Azure Monitor workbooks](../monitor/concepts-workbooks.md) for Azure HorizonDB.
...
- Public Preview of [Major Version Upgrade](../configure-maintain/concepts-major-version-upgrade.md) for Azure HorizonDB.
...
- General availability of [Microsoft Entra authentication support](../security/security-entra-concepts.md) for Azure HorizonDB in all Azure Public Regions.
- General availability of [Customer Managed Key feature](../security/security-data-encryption.md) with Azure HorizonDB in all Azure public regions.

## Release: December 2022

- Support for [pg_hint_plan](../extensions/concepts-extensions-versions.md#pg_hint_plan) extension with new servers. <sup>$</sup>
- General availability of [Customer Managed Key feature](../security/security-data-encryption.md) with Azure HorizonDB in Canada East, Canada Central, Southeast Asia, Switzerland North, Switzerland West, Brazil South, and East Asia Azure regions.
...
- Published [Security and compliance certifications](../security/security-compliance.md) for Azure HorizonDB.
...
- Support for updating Private DNS Zone for [Azure HorizonDB private networking](../network/concepts-networking-private.md) for existing servers<sup>$</sup>.
...
- Azure HorizonDB is [**Generally Available**](https://techcommunity.microsoft.com/t5/azure-database-for-postgresql/azure-database-for-postgresql-flexible-server-is-now-ga/ba-p/2987030).
