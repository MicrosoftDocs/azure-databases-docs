...
description: API release notes for Azure HorizonDB.
...
# API release notes - Azure HorizonDB 
...
For any questions or suggestions you might have on Azure HorizonDB, send an email to the Azure HorizonDB Team ([@Ask Azure HorizonDB](mailto:AskAzureDBforPostgreSQL@service.microsoft.com)). Note that this email address isn't a technical support alias.
