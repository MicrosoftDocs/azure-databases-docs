...
description: This article describes how to create a read replica of an Azure HorizonDB flexible server instance.
...
This article provides step-by-step instructions to create a read replica of an Azure HorizonDB flexible server instance.
...
Before setting up a read replica for your Azure HorizonDB flexible server instance, ensure the primary server is configured to meet the necessary prerequisites. Specific settings on the primary server can affect the ability to create replicas.
...
1. Select the Azure HorizonDB flexible server instance that you want to use as the primary server.
...
4. You're redirected to the **Add read replica to Azure HorizonDB** wizard, from where you can configure some settings for the new read replica that is created.
...
8.  A new deployment is launched to create your new Azure HorizonDB flexible server instance and make it a read replica of the primary server.
    
    :::image type="content" source="./media/how-to-read-replicas/create-replica-deployment-progress.png" alt-text="Screenshot that shows the deployment in progress to create your new Azure HorizonDB flexible server instance." lightbox="./media/how-to-read-replicas/create-replica-deployment-progress.png":::

9. When the deployment completes, you can select **Go to resource**, to start using your new Azure HorizonDB flexible server instance.

    :::image type="content" source="./media/how-to-read-replicas/create-replica-deployment-completed.png" alt-text="Screenshot that shows the deployment successfully completed of your Azure HorizonDB flexible server instance." lightbox="./media/how-to-read-replicas/create-replica-deployment-completed.png":::
