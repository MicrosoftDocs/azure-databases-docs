...
description: This article describes the virtual endpoints for read replica feature in an Azure HorizonDB flexible server instance.
...
This section explains how to use Virtual Endpoints in an Azure HorizonDB flexible server instance to maintain a consistent hostname during Point-in-Time Recovery (PITR) or Snapshot Restore, ensuring application connection strings remain unchanged. Follow below steps:
