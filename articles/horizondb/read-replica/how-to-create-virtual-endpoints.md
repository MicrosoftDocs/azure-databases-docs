---
title: Create Virtual Endpoints in Azure HorizonDB
description: This article describes how to create virtual endpoints in Azure HorizonDB.
...
# Create virtual endpoints in Azure HorizonDB

This article provides step-by-step instructions to create virtual endpoints in Azure HorizonDB.
...
1. Select the Azure HorizonDB instance for which you want to create virtual endpoints.
...
1. When the process completes, a notification informs you that the virtual endpoints were successfully created.
