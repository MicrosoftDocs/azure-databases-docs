...
description: This article describes how to create virtual endpoints for an Azure HorizonDB flexible server instance.
...
This article provides step-by-step instructions to create virtual endpoints for an Azure HorizonDB flexible server instance.
...
1. Select the Azure HorizonDB flexible server instance for which you want to create virtual endpoints.
