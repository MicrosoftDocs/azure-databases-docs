...
description: This article describes how to update virtual endpoints for an Azure HorizonDB flexible server.
...
This article provides step-by-step instructions to update virtual endpoints associated to an Azure HorizonDB flexible server.
...
1. Select the Azure HorizonDB flexible server for which you want to update its associated virtual endpoints.
