...
description: This article describes how you can monitor an Azure HorizonDB flexible server instance by using Azure Monitor workbooks.
...
# Monitor Azure HorizonDB  by using Azure Monitor workbooks
...
In this article, you learn about the various workbook templates available for your Azure HorizonDB flexible server instance.

An Azure HorizonDB flexible server instance has two available templates:
...
- **Enhanced metrics**: Displays a summary of enhanced metrics for your Azure HorizonDB flexible server instance, with more fine-grained database monitoring. To enable these metrics, enable the server parameters `metrics.collector_database_activity` and `metrics.autovacuum_diagnostics`. These parameters are dynamic and don't require a server restart. For more information, see [enhanced metrics](concepts-monitoring.md#enhanced-metrics) and [autovacuum metrics](concepts-monitoring.md#autovacuum-metrics). This template displays the following views:
