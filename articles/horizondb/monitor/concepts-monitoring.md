...
Prebuilt Grafana dashboards are embedded directly in the Azure portal for Azure HorizonDB at no additional cost and with no setup required. These dashboards are refreshed near real time to provide visibility into server health and performance.
