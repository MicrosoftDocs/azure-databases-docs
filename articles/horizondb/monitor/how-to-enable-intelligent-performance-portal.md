...
description: This article describes how to configure intelligent tuning in an Azure HorizonDB flexible server instance through the Azure portal.
...
# Configure intelligent tuning for Azure HorizonDB  by using the Azure portal

This article provides a step-by-step procedure to configure intelligent tuning in an Azure HorizonDB flexible server instance by using the Azure portal.
...
1. Visit the [Azure portal](https://portal.azure.com/) and select the Azure HorizonDB flexible server instance on which you want to enable intelligent tuning.
