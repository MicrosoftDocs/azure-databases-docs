...
description: This article describes best practices for query store in an Azure HorizonDB flexible server instance.
...
This article outlines best practices for using query store in an Azure HorizonDB flexible server instance.
