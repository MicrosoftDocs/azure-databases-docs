---
title: Add Private Endpoint Connections in Azure HorizonDB
description: This article describes how to add private endpoint connections in Azure HorizonDB.
...
ms.topic: how-to
# customer intent: As a user, I want to learn how to add private endpoint connections in Azure HorizonDB.
---

# Add private endpoint connections in Azure HorizonDB
...
1. If you have the required permissions to deploy a private endpoint, you can create it by selecting **Create private endpoint**.
...
1. Use the following table to understand the meaning of the different fields available in the **Basics** page, and as guidance to fill the page:
   ...
   | **Name** | The name that you want to assign to the private endpoint. | A unique name that identifies the private endpoint through which you could connect to your Azure HorizonDB. |
   ...
   | **Region** | The name of one of the [regions in which you can create private endpoints for Azure HorizonDB](/azure/private-link/availability#databases). | The region you select must match that of the virtual network in which you plan to deploy the private endpoint. |
1. In the **Resource** page, fill all the details required. Then, select **Next: Virtual Network**.
...
1. Use the following table to understand the meaning of the different fields available in the **Resource** page, and as guidance to fill the page:
   ...
   | Setting | Suggested value | Description |
   | --- | --- | --- |
   | **Resource type** | Automatically set to `Microsoft.DBforPostgreSQL/flexibleServers` | This value is automatically chosen for you, and corresponds to the type of resource that an Azure HorizonDB is, to the eyes of Azure Private Link. |
   | **Resource** | Automatically set to the name of the Azure HorizonDB for which you're creating the private endpoint. | The name of the resource to which the private endpoint connects to. |
...
1. In the **Virtual Network** page, fill all the details required. Then, select **Next: DNS**.
...
1. Use the following table to understand the meaning of the different fields available in the **Virtual Network** page, and as guidance to fill the page:
   ...
   | **Subnet** | Automatically set to the name of the Azure HorizonDB for which you're creating the private endpoint. | Only subnets in the currently selected virtual network are listed. |
...
1. In the **DNS** page, fill all the details required. Then, select **Next: Tags**.
...
1. A deployment is initiated, and you see a notification when the deployment completes.
