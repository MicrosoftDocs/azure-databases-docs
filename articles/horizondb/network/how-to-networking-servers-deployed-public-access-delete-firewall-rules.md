...
description: This article describes how to delete firewall rules to an Azure HorizonDB flexible server.
...
ms.topic: how-to
#customer intent: As a user, I want to learn how to delete firewall rules to an Azure HorizonDB.
---
