...
description: This article describes how to add firewall rules to an Azure HorizonDB flexible server.
...
ms.topic: how-to
#customer intent: As a user, I want to learn how to add firewall rules to an Azure HorizonDB.
---
