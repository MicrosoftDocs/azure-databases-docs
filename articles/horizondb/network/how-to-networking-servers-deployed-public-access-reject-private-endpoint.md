...
description: This article describes how to reject private endpoint connections to an Azure HorizonDB flexible server.
...
ms.topic: how-to
#customer intent: As a user, I want to learn how to reject private endpoint connections to an Azure HorizonDB.
---
