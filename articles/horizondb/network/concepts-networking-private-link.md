...
Private endpoints can only be configured for servers that were created after Azure HorizonDB introduced the support for Private Link, and whose networking mode was configured to not use virtual network integration but Public access.
