...
Create a new Maven project in your preferred IDE and add the dependencies for the Azure HorizonDB library.
...
public class CreateServer {
    public static void main(String[] args) throws Exception {
              ...
              .create();
              System.out.println("Azure HorizonDB Flexible server instance is created with server name"+server.name());
    }
}
```
