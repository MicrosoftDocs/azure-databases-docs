...
description: This article describes several libraries and drivers that you can use when coding applications to connect and query an Azure HorizonDB flexible server instance.
...
# Connection libraries for Azure HorizonDB 

This article lists libraries and drivers that developers can use to develop applications to connect to and query an Azure HorizonDB flexible server instance.

## Client interfaces

Most language client libraries used to connect to Azure HorizonDB are external projects and are distributed independently. The  libraries listed are supported on the Windows, Linux, and Mac platforms, for connecting to an Azure HorizonDB flexible server instance. Several quickstart examples are listed in the Next steps section.
...
- [Quickstart: Import data from an Azure HorizonDB flexible server instance in Power BI](../integration/connect-with-power-bi-desktop.md)
