---
title: Connection Types and Connectors in Azure HorizonDB
...
# Connection types and connectors in Azure HorizonDB
...
| **Azure CLI** | Use the [Quickstart: Connect and query with Azure CLI in Azure HorizonDB](connect-azure-cli.md) to connect and query your Azure HorizonDB cluster directly from the command line. |
| **VS Code extension** | The [What is the PostgreSQL extension for Visual Studio Code with HorizonDB](../development/vs-code-extension/vs-code-overview.md) allows you to connect, query, and manage your Azure HorizonDB cluster from within VS Code. |
...
| Go | [pq package](https://pkg.go.dev/github.com/lib/pq?utm_source=godoc) | Pure Go PostgreSQL driver | [Install](https://github.com/lib/pq/blob/master/README.md) |
...
| C++ | [libpqxx](https://pqxx.org) | C++ interface | [Download](https://pqxx.org/libpqxx/) |

## Connection pooling

For production workloads, use connection pooling to reduce connection overhead and improve performance. Azure HorizonDB offers [PgBouncer in Azure HorizonDB](concepts-pgbouncer.md) as a built-in connection pooling solution. PgBouncer runs on the same virtual machine as your database server and supports both public and private connections.
...
- Supports [Microsoft Entra authentication in Azure HorizonDB](../security/security-entra-concepts.md).
- Seamlessly restarts on failover to a standby server.

For guidance on selecting the right pooling strategy, see [Connection pooling strategy using PgBouncer in Azure HorizonDB](concepts-connection-pooling-best-practices.md).
...
For detailed configuration steps, see [Connect clients with TLS security to your database in Azure HorizonDB](../security/security-tls-how-to-connect.md).

## Authentication

Azure HorizonDB supports multiple authentication methods:

- **Microsoft Entra authentication**: Use Microsoft Entra ID (formerly Azure Active Directory) for centralized identity management and passwordless authentication. For details, see [Microsoft Entra authentication in Azure HorizonDB](../security/security-entra-concepts.md).
- **SCRAM authentication**: Use Salted Challenge Response Authentication Mechanism (SCRAM) for local database users with password-based authentication. For details, see [SCRAM authentication in Azure HorizonDB](../security/security-connect-scram.md).
- **Managed identity**: Connect applications using Azure managed identities to eliminate the need for credentials in application code. For details, see [Connect with managed identity in Azure HorizonDB](../security/security-connect-with-managed-identity.md).
...
| Language | Quickstart |
| --- | --- |
| Python | [Quickstart: Use Python to connect and query data in Azure HorizonDB](connect-python.md) |
| Java | [Quickstart: Use Java and JDBC in Azure HorizonDB](connect-java.md) |
| C\#/.NET | [Quickstart: Use .NET (C#) to connect and query data in Azure HorizonDB](connect-csharp.md) |
| Go | [Quickstart: Use Go language to connect and query data in Azure HorizonDB](connect-go.md) |
| PHP | [Quickstart: Use PHP to connect and query data in Azure HorizonDB](connect-php.md) |
| Azure CLI | [Quickstart: Connect and query with Azure CLI in Azure HorizonDB](connect-azure-cli.md) |

## Related content

- [Connection libraries in Azure HorizonDB](concepts-connection-libraries.md)
...
- [Transport Layer Security (TLS) in Azure HorizonDB](../security/security-tls.md)
