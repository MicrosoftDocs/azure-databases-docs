...
- To monitor PgBouncer metrics, ensure that **pgbouncer** feature is enabled via the Parameter `pgbouncer.enabled` and metrics parameter `metrics.pgbouncer_diagnostics` is enabled.
