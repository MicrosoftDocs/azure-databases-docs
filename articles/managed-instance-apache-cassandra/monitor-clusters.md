...
Use the Azure Monitor REST API for creating a diagnostic setting by using the interactive console. For more information, see [Diagnostic Settings](/rest/api/monitor/diagnosticsettings/createorupdate).
